...
export const EVAL_QUESTIONS: EvalQuestion[] = [
  ...
  { q: "Complétez : 他 ___ 会说汉语，___ 会写汉字。", qEn: "Complete: 他 ___ 会说汉语，___ 会写汉字。", choices: ["虽然…但是", "不管…都", "不但…而且", "不是…就是"], choicesEn: ["虽然…但是", "因为…所以", "不但…而且", "除了…以外"], correct: 2, level: "B2.1", skill: "grammar" },
