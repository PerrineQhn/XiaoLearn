/**
 * cecrBilans.ts — Bilans de fin de niveau CECR (mobile) — BILINGUE FR/EN
 * Régénéré depuis cecr-bilans.ts (web) avec champs *En.
 */

export type BilanQuestionType = 'mcq' | 'fill' | 'match';
export type CecrLevelSlug = 'a1' | 'a2' | 'b1.1' | 'b1.2' | 'b2.1' | 'b2.2' | 'c1.1' | 'c1.2' | 'c2.1' | 'c2.2';
...
/** Retourne n questions tirées aléatoirement du pool (sans remise). */
export function sampleBilanQuestions(bilan: LevelBilan, n = 10): BilanQuestion[] {
  const pool = [...bilan.questions];
...
export const cecrBilans: Record<CecrLevelSlug, LevelBilan> = {
  "a1": {
    ...
    "descriptionFr": "Valide les bases : salutations, pronoms, chiffres, 是, 有, les 4 tons de base et les premiers caractères usuels.",
    "descriptionEn": "Validates the foundations: greetings, pronouns, numbers, 是, 有, the 4 basic tones and the first common characters.",
    "emoji": "🌱",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      {
        "id": "a1-q1",
        "type": "mcq",
        "promptFr": "Comment dit-on « Bonjour » en chinois ?",
        "choices": [
          "再见 (zàijiàn)",
          "你好 (nǐhǎo)",
          "谢谢 (xièxie)",
        ...
        "correctIndex": 1,
        "explanationFr": "你好 signifie littéralement « tu bien » et s'utilise à toute heure. 再见 = « au revoir », 谢谢 = « merci », 对不起 = « désolé ».",
        "topic": "vocab",
        "promptEn": "How do you say \"Hello\" in Chinese?",
        "explanationEn": "你好 literally means \"you good\" and works at any time of day. 再见 = \"goodbye\", 谢谢 = \"thank you\", 对不起 = \"sorry\"."
      },
      {
        "id": "a1-q2",
        "type": "mcq",
        "promptFr": "Quel est le pronom personnel « je » en chinois ?",
        "choices": [
          "你 (nǐ)",
          "他 (tā)",
          "我 (wǒ)",
        ...
        "correctIndex": 2,
        "explanationFr": "我 (wǒ) = je / moi. 你 = tu, 他 = il, 她 = elle.",
        "topic": "grammar",
        "promptEn": "What is the personal pronoun \"I\" in Chinese?",
        "explanationEn": "我 (wǒ) = I / me. 你 = you, 他 = he, 她 = she."
      },
      {
        "id": "a1-q3",
        "type": "fill",
        ...
        "contextFr": "我 ___ 法国人。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I am French\").",
        "contextEn": "我 ___ 法国人。",
        "explanationEn": "是 (shì) means \"to be\". Structure A 是 B = A is B. \"我是法国人\" = \"I am French\"."
      },
      {
        "id": "a1-q4",
        "type": "mcq",
        ...
        "explanationEn": "三 (sān) = 3. Numbers 1-10: 一 (yī), 二 (èr), 三 (sān), 四 (sì), 五 (wǔ), 六 (liù), 七 (qī), 八 (bā), 九 (jiǔ), 十 (shí)."
      },
      {
        "id": "a1-q5",
        "type": "mcq",
        "promptFr": "Comment former une question fermée (oui/non) à partir de « 他是老师 » ?",
        "choices": [
          "他是老师吧",
          "他是老师吗",
          "他是老师呢",
        ...
        "correctIndex": 1,
        "explanationFr": "La particule 吗 placée en fin de phrase transforme une affirmation en question oui/non. 他是老师吗？ = « Est-il professeur ? »",
        "topic": "grammar",
        "promptEn": "How do you turn \"他是老师\" into a yes/no question?",
        "explanationEn": "The particle 吗 at the end of a sentence turns a statement into a yes/no question. 他是老师吗？ = \"Is he a teacher?\""
      },
      {
        "id": "a1-q6",
        "type": "mcq",
      ...
      },
      {
        ...
        "contextFr": "我 ___ 书。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below to say \"I don't have a book\".",
        "contextEn": "我 ___ 书。",
        "explanationEn": "The negation of 有 is ALWAYS 没有, never 不有. 不 does not negate 有. This is the unique exception: everywhere else, 不 is the standard negation."
      },
      {
        "id": "a1-q8",
        "type": "mcq",
        ...
        "explanationEn": "谢谢 (xièxie) = thank you. 对不起 = sorry, 请 = please (at the head of a request), 没关系 = it's nothing."
      },
      {
        "id": "a1-q9",
        "type": "mcq",
        ...
        "explanationEn": "个 is the all-purpose classifier: 一个人 (one person), 一个朋友 (one friend). 本 = for books, 只 = animals, 条 = long objects."
      },
      {
        "id": "a1-q10",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "谢 is pronounced xiè in the fourth tone (falling). In doubled form 谢谢 (xièxie), the second syllable is often reduced to neutral tone."
      },
      {
        "id": "a1-q12",
        "type": "mcq",
        ...
        "explanationEn": "爷爷 = paternal grandfather. 奶奶 = paternal grandmother. Chinese family terms distinguish paternal and maternal sides: 外公/外婆 for the maternal side."
      },
      {
        "id": "a1-q13",
        "type": "mcq",
        ...
        "explanationEn": "八 (bā) = 8. Eight is a lucky number in China because 八 sounds like 发 (fā, \"to prosper\")."
      },
      {
        "id": "a1-q14",
        "type": "fill",
        ...
        "contextFr": "A: ___ ！\nB: 你们好！",
        "topic": "dialogue",
        "promptEn": "Fill in: \"Hello, teacher!\"",
        "contextEn": "A: ___ ！\nB: 你们好！",
        "explanationEn": "The respectful greeting is NAME + 好: 老师好 (hello teacher), 大家好 (hello everyone). A fixed construction to memorize."
      },
      {
        "id": "a1-q15",
        "type": "mcq",
      ...
      },
      {
        "id": "a1-q16",
        "type": "mcq",
        "promptFr": "Comment dit-on « j'ai 25 ans » ?",
        "choices": [
          "我二十五岁",
          "我有二十五年",
          "我是二十五",
        ...
        "correctIndex": 0,
        "explanationFr": "L'âge se dit SUJET + NOMBRE + 岁. 我二十五岁 = « j'ai 25 ans ». Pas besoin de 是 ni de 有 : le verbe est implicite.",
        "topic": "vocab",
        "promptEn": "How do you say \"I am 25 years old\"?",
        "explanationEn": "Age is expressed as SUBJECT + NUMBER + 岁. 我二十五岁 = \"I am 25\". No need for 是 or 有: the verb is implicit."
      },
      {
        "id": "a1-q17",
        "type": "mcq",
        ...
        "explanationEn": "大 (dà) = big, 小 (xiǎo) = small. They are also affectionate prefixes: 小李 = \"little Li\" (informal), 大家 = \"everyone\" (lit. \"big family\").",
        "choicesEn": [
          "大 = big / 小 = small",
          "大 = small / 小 = big",
          "大 = old / 小 = young",
  ...
  "a2": {
    ...
    "descriptionFr": "Vérifie les acquis du quotidien : temps (了, 要, 会), questions ouvertes, lieu, possessif 的, expressions de base avec modaux.",
    "descriptionEn": "Checks daily-life foundations: time markers (了, 要, 会), open questions, location, 的 possessive, basic modals.",
    "emoji": "🌿",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      {
        ...
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"he went to Beijing\").",
        "contextEn": "他 ___ 北京 ___ 。",
        "explanationEn": "The marker 了 at the end of a sentence (or after the verb) signals a change of state or completed event. 他去北京了 = \"he went / left for Beijing\".",
        "choicesEn": [
          "去 / 了",
          "去 / 吗",
          "要 / 了",
      ...
      },
      {
        ...
        "explanationEn": "哪里 (nǎlǐ) or 哪儿 (nǎr, more colloquial) = \"where\". 什么 = what, 谁 = who, 几 = how many (small number)."
      },
      {
        "id": "a2-q3",
        "type": "mcq",
        "promptFr": "Quelle phrase signifie « Je veux boire du thé » ?",
        "choices": [
          "我喝茶了",
          "我想喝茶",
          "我会喝茶",
        ...
        "correctIndex": 1,
        "explanationFr": "想 exprime l'envie ou le souhait. 会 = savoir (faire), 了 = accompli, 没 = négation du passé.",
        "topic": "grammar",
        "promptEn": "Which sentence means \"I want to drink tea\"?",
        "explanationEn": "想 expresses desire or wish. 会 = to know how to, 了 = completed, 没 = past negation."
      },
      {
        "id": "a2-q4",
        "type": "fill",
        ...
        "contextFr": "我朋友 ___ 书。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"my friend's book\").",
        "contextEn": "我朋友 ___ 书。",
        "explanationEn": "的 marks possession or qualification: 我朋友的书 = my friend's book. 得 and 地 are different particles (complement / adverb)."
      },
      {
        "id": "a2-q5",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "星期 + number: 星期一 Monday, 星期二 Tuesday, 星期三 Wednesday, 星期四 Thursday, 星期五 Friday, 星期六 Saturday, 星期天 (or 星期日) Sunday."
      },
      {
        "id": "a2-q7",
        "type": "mcq",
        "promptFr": "Comment dire « demain il fera chaud » ?",
        "choices": [
          "昨天很热",
          "明天很热",
          "今天很冷",
        ...
        "correctIndex": 1,
        "explanationFr": "明天 = demain, 很热 = très chaud. 昨天 = hier, 今天 = aujourd'hui, 后天 = après-demain, 冷 = froid.",
        "topic": "vocab",
        "promptEn": "How do you say \"tomorrow will be hot\"?",
        "explanationEn": "明天 = tomorrow, 很热 = very hot. 昨天 = yesterday, 今天 = today, 后天 = the day after tomorrow, 冷 = cold."
      },
      {
        "id": "a2-q8",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous (« je sais parler chinois »).",
        "choices": [
          "想",
          "要",
          "会",
        ...
        "correctIndex": 2,
        "explanationFr": "会 = savoir (faire), compétence acquise par apprentissage. 想 = vouloir/envie, 要 = vouloir (plus ferme), 可以 = pouvoir (permission).",
        "contextFr": "我 ___ 说汉语。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I can speak Chinese\").",
        "contextEn": "我 ___ 说汉语。",
        "explanationEn": "会 = to know how to (a skill acquired through learning). 想 = to want / feel like, 要 = to want (stronger), 可以 = to be allowed to (permission)."
      },
      {
        "id": "a2-q9",
        "type": "mcq",
        ...
        "explanationEn": "多少 asks about a potentially large quantity (price, population). 几 asks about a small expected number (< 10). 多少钱 = how much does it cost."
      },
      {
        "id": "a2-q10",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "下午 = afternoon, 上午 = morning (before noon), 早上 = early morning, 晚上 = evening. 点 = o'clock. 下午三点 = 3pm."
      },
      {
        "id": "a2-q12",
        "type": "fill",
        ...
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I go home by bus\").",
        "contextEn": "我 ___ 公共汽车 ___ 。",
        "explanationEn": "坐 + vehicle = to take (seated transport). 我坐公共汽车回家 = I take the bus home. 开车 = to drive, 骑 = to ride astride (bike, motorbike).",
        "choicesEn": [
          "坐 / 回家",
          "开 / 回家",
          "走 / 回家",
      ...
      },
      {
        ...
        "explanationEn": "Chinese date order: YEAR + MONTH + DAY. 三月五号 = March 5 (lit. \"month 3 day 5\"). 号 is the spoken form of 日."
      },
      {
        "id": "a2-q14",
        "type": "mcq",
      ...
      },
      {
        ...
        "topic": "grammar",
        "promptEn": "Fill in: \"this piece of clothing is really pretty\" (with 是...的 for emphasis).",
        "contextEn": "这件衣服 ___ 很漂亮 ___ 。",
        "explanationEn": "是...的 emphasizes an element of the sentence (here the quality). 这件衣服是很漂亮的 = \"this piece of clothing really is pretty\".",
        "choicesEn": [
          "是 / 的",
          "在 / 的",
          "了 / 的",
      ...
      },
      {
        ...
        "explanationEn": "Standard order: SUBJECT + 很 + VERB/ADJ + OBJECT. 很 ALWAYS goes before the predicate (stative verb or adjective), never after the object."
      },
      {
        "id": "a2-q17",
        "type": "mcq",
      ...
      },
      {
        ...
        "contextFr": "我已经吃 ___ 。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I've already eaten\").",
        "contextEn": "我已经吃 ___ 。",
        "explanationEn": "了 marks completion here (action finished). 我已经吃了 = \"I've already eaten\". 过 marks experience (having done something at least once), 着 marks a persistent state."
      },
      {
        "id": "a2-q19",
        "type": "mcq",
        "promptFr": "Que signifie 觉得 ?",
        "choices": [
          "Dormir",
          "Penser / trouver que",
          "Être réveillé",
        ...
        "correctIndex": 1,
        "explanationFr": "觉得 (juéde) = trouver que, penser que (avis personnel). 我觉得很有意思 = « je trouve ça intéressant ». 睡觉 (shuìjiào) = dormir.",
        "topic": "vocab",
        "promptEn": "What does 觉得 mean?",
        "explanationEn": "觉得 (juéde) = to find that, to think that (personal opinion). 我觉得很有意思 = \"I find it interesting\". 睡觉 (shuìjiào) = to sleep.",
        "choicesEn": [
          "To sleep",
          "To think / find that",
          "To be awake",
      ...
      },
      {
        ...
        "explanationEn": "In Chinese, 踢 (to kick) is used for soccer: 踢足球. 打 is for racket or hand sports: 打篮球 (basketball), 打网球 (tennis). 玩 = to play (general)."
      }
    ]
  },
  "b1.1": {
    ...
    "descriptionFr": "Vérifie les premières structures complexes : 把, 比 (comparatif), 正在, compléments de degré, résultatifs simples, 给 ditransitif.",
    "descriptionEn": "Checks first complex structures: 把, 比 (comparative), 正在, degree complements, simple resultatives, 给 ditransitive.",
    "emoji": "🌸",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      {
        "id": "b11-q1",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous (« j'ai fini de lire ce livre »).",
        "choices": [
          "把 / 看",
          "在 / 看",
          "给 / 读",
        ...
        "correctIndex": 0,
        "explanationFr": "La structure 把 déplace l'objet avant le verbe pour insister sur le résultat de l'action. 把 + OBJ + VERBE + RÉSULTATIF. 我把这本书看完了 = « j'ai fini de lire ce livre ».",
        "contextFr": "我 ___ 这本书 ___ 完了。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I finished reading this book\").",
        "contextEn": "我 ___ 这本书 ___ 完了。",
        "explanationEn": "The 把 construction moves the object before the verb to emphasize the result of the action. 把 + OBJ + VERB + RESULTATIVE. 我把这本书看完了 = \"I finished reading this book\".",
        "choicesEn": [
          "把 / 看",
          "在 / 看",
          "给 / 读",
      ...
      },
      {
        ...
        "topic": "grammar",
        "promptEn": "How do you express \"He is taller than me\"?",
        "explanationEn": "Comparative structure: A + 比 + B + ADJ. 他比我高 = he is taller than me. 比 is NOT paired with 很 or 更 (except for special nuance)."
      },
      {
        "id": "b11-q3",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous (« il est en train de lire »).",
        "choices": [
          "在",
          "正在",
          "了",
      ...
      },
      {
        ...
        "explanationEn": "极了 goes AFTER the adjective to mark an extreme: 好极了 = excellent / great. Equivalents: 太...了, ...死了 (colloquial)."
      },
      {
        "id": "b11-q7",
        "type": "mcq",
        "promptFr": "Comment dire « J'ai étudié le chinois pendant 3 ans » ?",
        "choices": [
          "我三年学了汉语",
          "我学汉语了三年",
          "我学了三年汉语",
        ...
        "correctIndex": 2,
        "explanationFr": "Structure de la durée : SUJET + V + 了 + DURÉE + OBJET. 我学了三年汉语 = « j'ai étudié le chinois 3 ans ». La durée se place après 了 pour les phrases avec objet.",
        "topic": "grammar",
        "promptEn": "How do you say \"I studied Chinese for 3 years\"?",
        "explanationEn": "Duration structure: SUBJECT + V + 了 + DURATION + OBJECT. 我学了三年汉语 = \"I studied Chinese for 3 years\". The duration goes after 了 in sentences with an object."
      },
      {
        "id": "b11-q8",
        "type": "mcq",
        "promptFr": "Que veut dire « 一边...一边... » ?",
        "choices": [
      ...
      },
      {
        ...
        "explanationEn": "没 negates completed actions or experience (with 过). 我没去过中国 = \"I have never been to China\". For future or general statements, use 不."
      },
      {
        "id": "b11-q10",
        "type": "mcq",
        "promptFr": "Dans le dialogue ci-dessous, B trouve le film :",
        "choices": [
          "Court mais ennuyeux",
        ...
        "correctIndex": 1,
        "explanationFr": "挺...的 = « assez / plutôt... » (ton familier nuancé positif). 就是 = « c'est juste que... » (concession). 有点儿 = « un peu » (avec connotation légèrement négative).",
        "topic": "dialogue",
        "contextFr": "A: 你觉得这个电影怎么样？\nB: 挺好看的，就是有点儿长。",
        "promptEn": "In the dialogue below, B finds the movie:",
        "contextEn": "A: 你觉得这个电影怎么样？\nB: 挺好看的，就是有点儿长。",
        "explanationEn": "挺...的 = \"fairly / pretty...\" (colloquial, mildly positive). 就是 = \"it's just that...\" (concession). 有点儿 = \"a bit\" (with a slightly negative nuance).",
        "choicesEn": [
          "Short but boring",
          "Pretty good, just a bit long",
          "Long and excellent",
          "Too long to be good"
        ]
      },
      {
        ...
        "contextEn": "我听 ___ 了。",
        "explanationEn": "对 as a resultative means \"correctly, right\". 听懂 = to understand, 听对 = to have heard correctly (no mistake). 听完 = to have finished listening, 听好 = to listen carefully."
      },
      {
        "id": "b11-q12",
        "type": "mcq",
        ...
        "explanationEn": "Chinese places modifiers BEFORE the modified noun, with 的. 桌子上的红苹果 = \"the red apple (that is) on the table\". Order: determiner + 的 + head noun."
      },
      {
        "id": "b11-q13",
        "type": "mcq",
        "promptFr": "Que signifie le chengyu 入乡随俗 ?",
        "choices": [
        ...
        "correctIndex": 0,
        "explanationFr": "入乡随俗 (rù xiāng suí sú) = « entrer dans un village, en suivre les coutumes ». S'adapter aux usages locaux. Très courant pour parler d'interculturalité.",
        "topic": "culture",
        "promptEn": "What does the chengyu 入乡随俗 mean?",
        "explanationEn": "入乡随俗 (rù xiāng suí sú) = \"enter a village, follow its customs\". Adapt to local ways. Very common when discussing intercultural matters.",
        "choicesEn": [
          "When in Rome, do as the Romans do.",
          "Traveling far from home.",
          "Following ancestral customs.",
      ...
      },
      {
        ...
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I'm going to the cinema tomorrow\").",
        "contextEn": "我明天 ___ 电影院 ___ 电影。",
        "explanationEn": "Serial verb structure: 我明天去电影院看电影 = \"I'm going to the cinema tomorrow to see a movie\". 去 introduces the destination, the second verb the purpose.",
        "choicesEn": [
          "去 / 看",
          "看 / 去",
          "到 / 看",
      ...
      },
      {
        ...
        "explanationEn": "Structure: 从 + START + 开始 + ACTION. 从今天早上开始下雨 = \"it has been raining since this morning\". 从 = since, 开始 = to begin."
      },
      {
        "id": "b11-q17",
        "type": "fill",
        ...
        "contextFr": "我去 ___ 中国。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I have been to China before\").",
        "contextEn": "我去 ___ 中国。",
        "explanationEn": "过 marks lived experience at least once. 我去过中国 = \"I have been to China (at least once)\". Distinct from 了 (specific completed action)."
      },
      {
        "id": "b11-q18",
        "type": "mcq",
        "promptFr": "Que veut dire 千万 dans « 你千万要小心 » ?",
        "choices": [
          "Dix millions",
          "Absolument / surtout",
          "Mille fois",
      ...
      },
      {
        ...
        "explanationEn": "着 goes IMMEDIATELY after the main verb to mark a maintained state or posture. 他坐着看书 = \"he reads while sitting\". Structure: V1 + 着 + V2."
      },
      {
        "id": "b11-q20",
        "type": "fill",
        ...
        "topic": "grammar",
        "promptEn": "Fill in: He is 3 years younger than me.",
        "contextEn": "他 ___ 我 ___ 三岁。",
        "explanationEn": "Numeric comparative structure: A + 比 + B + ADJ + GAP. 他比我小三岁 = \"he is 3 years younger than me\". 小 is used for age, not 少.",
        "choicesEn": [
          "比 / 小",
          "比 / 少",
          "从 / 小",
  ...
  "b1.2": {
    ...
    "descriptionFr": "Teste les connecteurs logiques (虽然...但是, 如果...就, 因为...所以), le passif 被, la causation 让/叫, les compléments directionnels.",
    "descriptionEn": "Tests logical connectors, 被 passive, 让/叫 causatives, directional complements.",
    "emoji": "🌼",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      {
        "id": "b12-q1",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous avec la paire de connecteurs adéquate.",
        "choices": [
          "因为 / 所以",
          "虽然 / 但是",
          "如果 / 就",
        ...
        "correctIndex": 1,
        "explanationFr": "La paire 虽然...但是 = « bien que... cependant » marque une concession. Les autres paires expriment cause/conséquence, condition, ou addition.",
        "contextFr": "___ 天气很冷，___ 我们还是去跑步了。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below with the right connector pair.",
        "contextEn": "___ 天气很冷，___ 我们还是去跑步了。",
        "explanationEn": "The pair 虽然...但是 = \"although... nevertheless\" marks a concession. The other pairs express cause/effect, condition, or addition.",
        "choicesEn": [
          "因为 / 所以",
          "虽然 / 但是",
          "如果 / 就",
      ...
      },
      {
        ...
        "explanationEn": "Passive structure: PATIENT + 被 + AGENT + VERB + COMPLEMENT. 我被他看见了 = \"I was seen by him\". 被 introduces the agent, not the patient."
      },
      {
        "id": "b12-q3",
        "type": "mcq",
      ...
      },
      {
        "id": "b12-q4",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous (« il est entré dans la salle, vers le locuteur »).",
        "choices": [
          "进 / 来",
          "上 / 去",
          "出 / 来",
        ...
        "correctIndex": 0,
        "explanationFr": "Complément directionnel composé : VERBE + 进 (entrer dans) + 来/去 (vers locuteur / loin de). 走进教室来 = « entrer dans la salle (vers moi) ».",
        "contextFr": "他走 ___ 教室 ___ 。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"he entered the classroom, toward the speaker\").",
        "contextEn": "他走 ___ 教室 ___ 。",
        "explanationEn": "Compound directional complement: VERB + 进 (to enter) + 来/去 (toward speaker / away from speaker). 走进教室来 = \"to walk into the classroom (toward me)\".",
        "choicesEn": [
          "进 / 来",
          "上 / 去",
          "出 / 来",
      ...
      },
      {
        ...
        "explanationEn": "越来越 + ADJ/V = \"more and more\". 越来越难 = more and more difficult. This is a very common fixed structure."
      },
      {
        "id": "b12-q6",
        "type": "fill",
        ...
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"if you have time, call me\").",
        "contextEn": "___ 你有时间，___ 给我打电话。",
        "explanationEn": "如果...就... = the conditional \"if... then...\". 如果你有时间，就给我打电话 = \"if you have time, call me\". 就 is optional but very common.",
        "choicesEn": [
          "因为 / 所以",
          "如果 / 就",
          "虽然 / 但是",
      ...
      },
      {
        "id": "b12-q9",
        "type": "mcq",
        "promptFr": "Que veut dire le chengyu 马马虎虎 ?",
        "choices": [
          "Très bien",
          "Comme-ci, comme-ça",
          "Très rapide",
        ...
        "correctIndex": 1,
        "explanationFr": "马马虎虎 (mǎmǎhūhū) signifie littéralement « cheval cheval tigre tigre » et s'emploie pour dire « bof », « passable », « ni bien ni mal ». Très courant à l'oral.",
        "topic": "culture",
        "promptEn": "What does the chengyu 马马虎虎 mean?",
        "explanationEn": "马马虎虎 (mǎmǎhūhū) literally means \"horse horse tiger tiger\" and is used to say \"so-so\", \"passable\", \"neither good nor bad\". Very common in speech.",
        "choicesEn": [
          "Very good",
          "So-so",
          "Very fast",
      ...
      },
      {
        "id": "b12-q12",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous (« plus tu apprends, plus tu progresses »).",
        "choices": [
          "越 / 越",
          "更 / 更",
          "比 / 比",
        ...
        "correctIndex": 0,
        "explanationFr": "越 + V1，越 + V2 = « plus on V1, plus on V2 ». 你越学，越进步 = « plus tu apprends, plus tu progresses ». Structure de gradation parallèle.",
        "contextFr": "你 ___ 学，___ 进步。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"the more you learn, the more you progress\").",
        "contextEn": "你 ___ 学，___ 进步。",
        "explanationEn": "越 + V1，越 + V2 = \"the more one V1s, the more one V2s\". 你越学，越进步 = \"the more you learn, the more you progress\". Parallel gradation structure.",
        "choicesEn": [
          "越 / 越",
          "更 / 更",
          "比 / 比",
      ...
      },
      {
        "id": "b12-q14",
        "type": "mcq",
        "promptFr": "Quel mot signifie « bien que / même si » au registre familier ?",
        "choices": [
          "尽管",
          "哪怕",
          "虽说",
        ...
        "correctIndex": 2,
        "explanationFr": "虽说 = registre oral familier de 虽然. 尽管 = bien que (un peu plus soutenu), 即便/哪怕 = même si (concessif fort). À l'oral, 虽说 sonne plus naturel.",
        "topic": "vocab",
        "promptEn": "Which word means \"although / even though\" in a colloquial register?",
        "explanationEn": "虚说 = oral, colloquial register of 虽然. 尽管 = although (a bit more formal), 即便/哪怕 = even if (strong concession). In speech, 虚说 sounds more natural."
      },
      {
        "id": "b12-q15",
        "type": "fill",
      ...
      },
      {
        "id": "b12-q16",
        "type": "mcq",
        "promptFr": "Comment exprimer « plus on est nombreux, plus c'est joyeux » ?",
        "choices": [
          "人越多越热闹",
          "人多越热闹越",
          "越人多越热闹",
        ...
        "correctIndex": 0,
        "explanationFr": "Structure 越... 越... avec sujet : SUJET + 越 + ADJ1，越 + ADJ2. 人越多越热闹 = « plus il y a de monde, plus c'est animé ». Proverbe quotidien.",
        "topic": "grammar",
        "promptEn": "How do you express \"the more people, the livelier\"?",
        "explanationEn": "越... 越... structure with a subject: SUBJECT + 越 + ADJ1，越 + ADJ2. 人越多越热闹 = \"the more people there are, the livelier it gets\". A everyday saying."
      },
      {
        "id": "b12-q17",
        "type": "mcq",
        "promptFr": "Que signifie 不见得 ?",
        "choices": [
          "Invisible",
          "Pas forcément / pas si sûr",
          "Jamais vu",
          "Très évident"
        ],
        "correctIndex": 1,
        "explanationFr": "不见得 = « pas forcément, ce n'est pas dit que ». Adoucisseur très utilisé pour exprimer le doute. 他不见得会来 = « il ne viendra pas forcément ».",
        "topic": "vocab",
        "promptEn": "What does 不见得 mean?",
        "explanationEn": "不见得 = \"not necessarily, it's not certain that\". A very common hedge to express doubt. 他不见得会来 = \"he won't necessarily come\".",
        "choicesEn": [
          "Invisible",
          "Not necessarily / not so sure",
          "Never seen",
          "Very obvious"
        ]
      },
  ...
  "b2.1": {
    ...
    "descriptionFr": "Évalue les nuances : 连...都/也, 不但...而且, 除了...以外, la distinction 得/的/地, et un vocabulaire plus abstrait.",
    "descriptionEn": "Tests nuances: 连...都/也, 不但...而且, 除了...以外, the 得/的/地 distinction, and more abstract vocabulary.",
    "emoji": "🌳",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      {
        ...
        "contextFr": "他跑 ___ 很快。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"he runs fast\").",
        "contextEn": "他跑 ___ 很快。",
        "explanationEn": "得 introduces a degree / manner complement AFTER the verb: 跑得快 = \"runs fast\". 的 = possessive, 地 = turns an adjective into an adverb before the verb."
      },
      {
        "id": "b21-q2",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "除了 + NOUN + 以外，subject + 都/也... = \"except / apart from + NOUN, the others...\". 除了他以外，别人都来了 = \"apart from him, the others all came\"."
      },
      {
        "id": "b21-q5",
        "type": "mcq",
      ...
      },
      {
        "id": "b21-q6",
        "type": "mcq",
        "promptFr": "Quel terme correspond le mieux à « économie » ?",
        "choices": [
          "经济",
          "政治",
          "文化",
        ...
        "correctIndex": 0,
        "explanationFr": "经济 = économie. 政治 = politique, 文化 = culture, 科学 = science. Vocabulaire abstrait standard HSK 4.",
        "topic": "vocab",
        "promptEn": "Which term best matches \"economy\"?",
        "explanationEn": "经济 = economy. 政治 = politics, 文化 = culture, 科学 = science. Standard HSK 4 abstract vocabulary."
      },
      {
        "id": "b21-q7",
        "type": "fill",
        ...
        "contextEn": "她说话 ___ 礼貌。",
        "explanationEn": "得 + ADJ + 很 (or 得很 at the end) = degree complement. 她说话说得很礼貌 = \"she speaks very politely\". 很 follows the adjective carried by 得.",
        "choicesEn": [
          "得很",
          "的很",
          "地很",
      ...
      },
      {
        ...
        "explanationEn": "无论...都... = \"no matter what...\" (universality). 无论 X 都 Y = \"regardless of X, Y\". 无论他去哪儿，都带着相机 = \"wherever he goes, he takes his camera\"."
      },
      {
        "id": "b21-q10",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "环境 = environment, surroundings. 场所 = venue (public), 位置 = position, 范围 = scope. 保护环境 = protect the environment."
      },
      {
        "id": "b21-q14",
        "type": "fill",
        "promptFr": "Complète la phrase ci-dessous (« j'attends depuis 2 heures, il n'est toujours pas venu »).",
        "choices": [
          "了 / 还",
          "过 / 也",
          "着 / 也",
        ...
        "correctIndex": 0,
        "explanationFr": "Structure de durée + 还/还没 : 我等了两个小时，他还没来 = « j'attends depuis 2h, il n'est toujours pas venu ». 还 marque la persistance / continuation.",
        "contextFr": "我等 ___ 两个小时，他 ___ 没来。",
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"I've been waiting 2 hours, he still hasn't come\").",
        "contextEn": "我等 ___ 两个小时，他 ___ 没来。",
        "explanationEn": "Duration + 还/还没 structure: 我等了两个小时，他还没来 = \"I've waited 2 hours, he still hasn't come\". 还 marks persistence / continuation.",
        "choicesEn": [
          "了 / 还",
          "过 / 也",
          "着 / 也",
  ...
  "b2.2": {
    ...
    "descriptionFr": "Pousse l'expression : interactions 把 + 被, topique-commentaire, 万一 / 宁可, chengyu de la vie active, vocabulaire média et débat.",
    "descriptionEn": "Pushes expression: 把 + 被 interactions, topic-comment inversion, 万一 / 宁可, active-life chengyu, media & debate vocabulary.",
    "emoji": "🎋",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      ...
      },
      {
        ...
        "topic": "grammar",
        "promptEn": "Fill in the sentence below with the emphasis particle.",
        "contextEn": "这本书 ___ 妈妈送给我的，特别珍贵。",
        "explanationEn": "Here 是...的 emphasizes the complement (who gave it). 是妈妈送给我的 = \"it's mom who gave it to me\". 被 would be semantically wrong in this relational context.",
        "choicesEn": [
          "是",
          "被",
          "把",
      ...
      },
      {
        ...
        "correctIndex": 1,
        "explanationFr": "好像 = « on dirait que / sembler » — adoucisseur prudentiel très courant. 他好像累了 = « on dirait qu'il est fatigué ».",
        "topic": "vocab",
        "promptEn": "What does \"好像\" mean?",
        "explanationEn": "好像 = \"it seems / one would say\" — a very common hedging softener. 他好像累了 = \"he seems tired\".",
        "choicesEn": [
          "To resemble well",
      ...
      },
      {
        ...
        "explanationEn": "Fixed structure: 无论 + QUESTION (什么 / 怎么 / 谁...), 都 + RESULT. 无论他做什么，都能成功 = \"no matter what he does, he succeeds\"."
      },
      {
        "id": "b22-q10",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "发表 = to publish (an article, a speech, an opinion). 出现 = to appear, 发生 = to happen, 表现 = to display / performance. Media vocabulary."
      },
      {
        "id": "b22-q12",
        "type": "mcq",
  ...
  "c1.1": {
    ...
    "descriptionFr": "Teste les chengyu d'usage, les connecteurs fins (尽管, 何况, 以免), et le vocabulaire abstrait (思想, 观念, 责任).",
    "descriptionEn": "Tests common chengyu, fine connectors, and abstract vocabulary.",
    "emoji": "🌲",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      ...
      },
      {
        ...
        "topic": "grammar",
        "promptEn": "Fill in the sentence below (\"although it's raining, we're going anyway\").",
        "contextEn": "___ 下雨，我们 ___ 去爬山。",
        "explanationEn": "尽管...还是... = \"even though... still...\". Similar to 虽然...但是 but a slightly higher register, emphasizing persistence.",
        "choicesEn": [
          "尽管 / 还是",
          "虽然 / 但是",
          "如果 / 就",
      ...
      },
      {
        ...
        "explanationEn": "观念 = concept / notion (more abstract, often cultural or moral). 观点 = viewpoint, 意见 = opinion (concrete), 主张 = a position defended."
      },
      {
        "id": "c11-q6",
        "type": "mcq",
      ...
      },
      {
        "id": "c11-q7",
        "type": "mcq",
        "promptFr": "Comment rendre « rien que d'y penser, j'ai envie de rire » ?",
        "choices": [
          "我想笑一想",
          "一想就我笑",
          "我一想就想笑",
        ...
        "explanationEn": "一 + V1 + 就 + V2 = \"as soon as V1, V2\". 我一想就想笑 = \"as soon as I think about it, I want to laugh\". A fixed structure linking action and immediate consequence."
      },
      {
        "id": "c11-q8",
        "type": "mcq",
      ...
      },
      {
        "id": "c11-q12",
        "type": "mcq",
        "promptFr": "Quel terme signifie « efficacité » au sens d'optimisation des ressources ?",
        "choices": [
          "效率",
          "效果",
          "结果",
        ...
        "correctIndex": 0,
        "explanationFr": "效率 = efficacité (rendement, productivité). 效果 = effet (résultat observé), 结果 = résultat / conclusion, 作用 = fonction / rôle. 提高效率 = améliorer l'efficacité.",
        "topic": "vocab",
        "promptEn": "Which term means \"efficiency\" in the sense of optimizing resources?",
        "explanationEn": "效率 = efficiency (yield, productivity). 效果 = effect (observed result), 结果 = result / conclusion, 作用 = function / role. 提高效率 = to improve efficiency."
      }
    ]
  },
  "c1.2": {
    ...
    "descriptionFr": "Valide le registre argumentatif : 以...为..., 反之, 倒, questions rhétoriques, distinction oral/écrit.",
    "descriptionEn": "Validates argumentative register: 以...为..., 反之, 倒, rhetorical questions, spoken-written distinction.",
    "emoji": "🏯",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      ...
      },
      {
        "id": "c12-q5",
        "type": "mcq",
        "promptFr": "Lequel est le plus soutenu ?",
        "choices": [
          "所以",
          "因此",
          "因为所以",
        ...
        "correctIndex": 1,
        "explanationFr": "因此 est le plus soutenu (« par conséquent »). 所以 est neutre. 因为...所以... est courant à l'oral mais lourd à l'écrit, on préfère ...因此... ou simplement 所以 seul.",
        "topic": "grammar",
        "promptEn": "Which is the most formal?",
        "explanationEn": "因此 is the most formal (\"consequently\"). 所以 is neutral. 因为...所以... is common in speech but heavy in writing; prefer ...因此... or just 所以 alone."
      },
      {
        "id": "c12-q6",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "In formal / literary writing, final modal particles (吧/啊/呢) are reduced or absent. 矣 is a classical trace (guwen). Academic texts rarely use oral particles.",
        "choicesEn": [
          "吧",
          "啊",
          "矣 (classical) or no final particle",
          "呢"
        ]
      },
      {
  ...
  "c2.1": {
    ...
    "descriptionFr": "Teste les structures littéraires, le vocabulaire économique et politique, et les tournures héritées du chinois classique.",
    "descriptionEn": "Tests literary structures, economic/political vocabulary, classical-influenced turns of phrase.",
    "emoji": "⛩️",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      ...
      },
      {
        "id": "c21-q2",
        "type": "mcq",
        "promptFr": "Le chengyu 趋之若鹜 s'emploie quand :",
        "choices": [
        ...
        "correctIndex": 0,
        "explanationFr": "趋之若鹜 : « se ruer comme des canards sauvages ». Souvent péjoratif : critique la foule qui suit une mode sans discernement.",
        "topic": "culture",
        "promptEn": "The chengyu 趋之若鹜 is used when:",
        "explanationEn": "趋之若鹜: \"to rush like wild ducks\". Often pejorative: criticizes the crowd that follows a fad without discernment.",
        "choicesEn": [
          "People rush in droves toward something (often with a critical connotation).",
          "Birds fly east.",
          "One chases an impossible dream.",
          "One gives up halfway."
        ]
      },
      {
        "id": "c21-q3",
      ...
      },
      {
        ...
        "explanationEn": "不但...而且（更）... = \"not only... but (even more)...\". The presence of 更 strengthens the gradation. A polished structure in writing."
      },
      {
        "id": "c21-q8",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "文化遗产 = cultural heritage. 文化背景 = cultural background, 文化交流 = cultural exchanges, 文化差异 = cultural differences. UNESCO / institutional vocabulary."
      },
      {
        "id": "c21-q14",
        "type": "mcq",
        "promptFr": "Que signifie 旨在 dans « 本政策旨在改善民生 » ?",
        "choices": [
          "A pour but de",
          "Hésite à",
          "Refuse de",
        ...
        "correctIndex": 0,
        "explanationFr": "旨在 = « avoir pour but de / viser à ». Registre administratif et écrit. 本政策旨在改善民生 = « cette politique vise à améliorer le bien-être de la population ».",
        "topic": "grammar",
        "promptEn": "What does 旨在 mean in \"本政策旨在改善民生\"?",
        "explanationEn": "旨在 = \"to aim at / to be intended to\". Administrative, written register. 本政策旨在改善民生 = \"this policy aims to improve people's welfare\".",
        "choicesEn": [
          "Aims to",
          "Hesitates to",
          "Refuses to",
  ...
  "c2.2": {
    ...
    "descriptionFr": "Bilan final : tournures rhétoriques, échos classiques (亦, 矣, 也), vocabulaire savant, poésie et proverbes lettrés.",
    "descriptionEn": "Final level check: rhetorical turns, classical echoes, scholarly vocabulary, literary proverbs.",
    "emoji": "🎎",
    "passingScore": 0.8,
    "xpReward": 60,
    "questions": [
      {
        "id": "c22-q1",
        "type": "mcq",
        "promptFr": "Le chengyu 青出于蓝而胜于蓝 évoque :",
        "choices": [
        ...
        "correctIndex": 1,
        "explanationFr": "青出于蓝而胜于蓝 : « le bleu-vert sort de l'indigo mais le surpasse ». Tiré de Xunzi. Signifie que l'élève peut dépasser son maître.",
        "topic": "culture",
        "promptEn": "The chengyu 青出于蓝而胜于蓝 evokes:",
        "explanationEn": "青出于蓝而胜于蓝: \"blue-green comes from indigo but surpasses it\". From Xunzi. Means the student can surpass the master.",
        "choicesEn": [
      ...
      },
      {
        "id": "c22-q4",
        "type": "mcq",
        "promptFr": "Quel terme signifie « conjoncture » dans un contexte économique/politique ?",
        "choices": [
          "局势",
          "情况",
          "方面",
        ...
        "correctIndex": 0,
        "explanationFr": "局势 = conjoncture, situation globale. 情况 = situation (plus neutre et local). 局势紧张 = la situation est tendue. Vocabulaire éditorial / géopolitique.",
        "topic": "vocab",
        "promptEn": "Which term means \"conjuncture\" in an economic / political context?",
        "explanationEn": "局势 = conjuncture, overall situation. 情况 = situation (more neutral, local). 局势紧张 = the situation is tense. Editorial / geopolitical vocabulary.",
        "choicesEn": [
          "局势",
          "情况",
          "方面",
      ...
      },
      {
        ...
        "explanationEn": "独树一帜: \"to plant one's own flag\" = to stand out, to have one's own style. 在该领域 = \"in this field\" (formal register with the literary demonstrative 该)."
      },
      {
        "id": "c22-q9",
        "type": "mcq",
      ...
      },
      {
        ...
        "explanationEn": "综上所述 = \"in summary\". 此议 = \"this proposal\" (此 literary demonstrative). 具有深远影响 = \"has a far-reaching impact\". 值得进一步探讨 = \"deserves further exploration\". A complete academic-conclusion formula."
      }
    ]
  }
};
