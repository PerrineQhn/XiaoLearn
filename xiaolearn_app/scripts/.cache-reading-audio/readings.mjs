...
import { cecrB2ExtraReadings } from './cecr-b2-texts.mjs';
// Task #43 : 12 textes supplémentaires couvrant A1 → C2.2.
import { cecrExtraReadings } from './cecr-extra-readings.mjs';
// Task #47 : +13 textes (vie quotidienne + contes classiques chinois).
import { cecrTalesDailyReadings } from './cecr-tales-daily-readings.mjs';
...
export const getReadingById = (id) => readings.find((r) => r.reading.id === id)?.reading;
export const getReadingsByLevel = (level) => readings.filter((r) => r.cecrLevel === level);
