/**
 * cecr-extra-readings.ts — Extension du catalogue de lectures XiaoLearn
 * ----------------------------------------------------------------------
 * Task #43 — Ajout de 12 nouveaux textes couvrant A1 → C2.2 pour :
 *   - densifier A1, A2, B1.1, B1.2 (1 texte suppl. chacun)
 *   - ajouter B2.1 et B2.2 (1 texte suppl. chacun)
 *   - initialiser C1.1 et C1.2 (2 textes chacun)
 *   - initialiser C2.1 et C2.2 (1 texte chacun)
 *
 * Chaque texte respecte la structure de `ReadingEntry` importée depuis
 * `./readings.ts`. Les IDs suivent la convention `rd-<levelSlug>-<slug>`.
 * L'audio sera généré par `scripts/generate-reading-audio.mjs` (Azure TTS),
 * une voix unique par texte (narration type livre audio).
 */
import type { ReadingEntry } from './readings';

export const cecrExtraReadings: ReadingEntry[] = [
  // ============================================================
  //  A1 — Ma chambre
  // ============================================================
  {
