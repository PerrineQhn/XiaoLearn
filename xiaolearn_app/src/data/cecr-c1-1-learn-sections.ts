...
export const c11ConvM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '论点', pinyin: 'lùndiǎn', meaning: 'thèse, argument', meaningEn: 'thesis', audio: 'audio/hsk6/hsk6_论点.wav' },
      { hanzi: '综上所述', pinyin: 'zōngshàngsuǒshù', meaning: 'en somme', meaningEn: 'in sum', audio: 'audio/hsk6/hsk6_综上.wav' },
      { hanzi: '指正', pinyin: 'zhǐzhèng', meaning: 'corriger (poliment)', meaningEn: 'kindly correct', audio: 'audio/hsk6/hsk6_指正.wav' },
      { hanzi: '不足', pinyin: 'bùzú', meaning: 'insuffisance', meaningEn: 'shortcoming', audio: 'audio/hsk5/hsk5_不足.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '提问', pinyin: 'tíwèn', meaning: 'poser une question', meaningEn: 'pose a question', audio: 'audio/hsk5/hsk5_提问.wav' },
      { hanzi: '深入', pinyin: 'shēnrù', meaning: 'approfondir', meaningEn: 'go deep', audio: 'audio/hsk5/hsk5_深入.wav' },
      { hanzi: '初步', pinyin: 'chūbù', meaning: 'préliminaire', meaningEn: 'preliminary', audio: 'audio/hsk6/hsk6_初步.wav' },
      { hanzi: '解答', pinyin: 'jiědá', meaning: 'répondre, élucider', meaningEn: 'answer (formal)', audio: 'audio/hsk6/hsk6_解答.wav' },
      { hanzi: '疑问', pinyin: 'yíwèn', meaning: 'doute, question', meaningEn: 'query', audio: 'audio/hsk5/hsk5_疑问.wav' }
    ],
    tip:
...
export const c11ConvM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '担任', pinyin: 'dānrèn', meaning: 'occuper (poste)', meaningEn: 'hold (position)', audio: 'audio/hsk5/hsk5_担任.wav' },
      { hanzi: '擅长', pinyin: 'shàncháng', meaning: 'être bon en', meaningEn: 'be good at', audio: 'audio/hsk5/hsk5_擅长.wav' },
      { hanzi: '完美', pinyin: 'wánměi', meaning: 'parfait', meaningEn: 'perfect', audio: 'audio/hsk5/hsk5_完美.wav' },
      { hanzi: '领先', pinyin: 'lǐngxiān', meaning: 'leader, en tête', meaningEn: 'leading', audio: 'audio/hsk5/hsk5_领先.wav' },
      { hanzi: '薪资', pinyin: 'xīnzī', meaning: 'salaire', meaningEn: 'salary', audio: 'audio/hsk6/hsk6_薪资.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '高级', pinyin: 'gāojí', meaning: 'senior', meaningEn: 'senior', audio: 'audio/hsk5/hsk5_高级.wav' },
      { hanzi: '工程师', pinyin: 'gōngchéngshī', meaning: 'ingénieur', meaningEn: 'engineer', audio: 'audio/hsk5/hsk5_工程师.wav' },
      { hanzi: '丰富', pinyin: 'fēngfù', meaning: 'riche, abondant', meaningEn: 'rich', audio: 'audio/hsk4/hsk4_丰富.wav' },
      { hanzi: '独到', pinyin: 'dúdào', meaning: 'unique', meaningEn: 'unique', audio: 'audio/hsk6/hsk6_独到.wav' },
      { hanzi: '见解', pinyin: 'jiànjiě', meaning: 'point de vue, vision', meaningEn: 'insight', audio: 'audio/hsk6/hsk6_见解.wav' }
    ],
    tip:
...
export const c11ConvM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '诚然', pinyin: 'chéngrán', meaning: 'certes, à vrai dire', meaningEn: 'admittedly', audio: 'audio/hsk6/hsk6_诚然.wav' },
      { hanzi: '然而', pinyin: 'ránér', meaning: 'cependant', meaningEn: 'however', audio: 'audio/hsk5/hsk5_然而.wav' },
      { hanzi: '坚信', pinyin: 'jiānxìn', meaning: 'croire fermement', meaningEn: 'firmly believe', audio: 'audio/hsk6/hsk6_坚信.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '忽略', pinyin: 'hūlüè', meaning: 'négliger', meaningEn: 'overlook', audio: 'audio/hsk6/hsk6_忽略.wav' },
      { hanzi: '商榷', pinyin: 'shāngquè', meaning: 'discuter, débattre', meaningEn: 'discuss, debate', audio: 'audio/hsk6/hsk6_商榷.wav' },
      { hanzi: '推理', pinyin: 'tuīlǐ', meaning: 'raisonnement', meaningEn: 'reasoning', audio: 'audio/hsk6/hsk6_推理.wav' },
      { hanzi: '解读', pinyin: 'jiědú', meaning: 'interprétation', meaningEn: 'interpretation', audio: 'audio/hsk6/hsk6_解读.wav' },
      { hanzi: '倾向', pinyin: 'qīngxiàng', meaning: 'pencher vers', meaningEn: 'lean toward', audio: 'audio/hsk5/hsk5_倾向.wav' }
    ],
    tip:
...
export const c11ConvM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '关注', pinyin: 'guānzhù', meaning: 'attention, intérêt', meaningEn: 'attention', audio: 'audio/hsk5/hsk5_关注.wav' },
      { hanzi: '复杂', pinyin: 'fùzá', meaning: 'complexe', meaningEn: 'complex', audio: 'audio/hsk4/hsk4_复杂.wav' },
      { hanzi: '为时过早', pinyin: 'wéishíguòzǎo', meaning: 'trop tôt', meaningEn: 'too early', audio: 'audio/hsk6/hsk6_为时.wav' },
      { hanzi: '敏感', pinyin: 'mǐngǎn', meaning: 'sensible', meaningEn: 'sensitive', audio: 'audio/hsk5/hsk5_敏感.wav' },
      { hanzi: '谨慎', pinyin: 'jǐnshèn', meaning: 'prudent', meaningEn: 'prudent', audio: 'audio/hsk6/hsk6_谨慎.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '重申', pinyin: 'chóngshēn', meaning: 'réitérer', meaningEn: 'reiterate', audio: 'audio/hsk6/hsk6_重申.wav' },
      { hanzi: '坚决', pinyin: 'jiānjué', meaning: 'résolument', meaningEn: 'resolutely', audio: 'audio/hsk5/hsk5_坚决.wav' },
      { hanzi: '呼吁', pinyin: 'hūyù', meaning: 'appeler à', meaningEn: 'call upon', audio: 'audio/hsk6/hsk6_呼吁.wav' }
    ],
    tip:
...
export const c11ConvM5LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '吃饱', pinyin: 'chībǎo', meaning: 'avoir mangé à sa faim', meaningEn: 'be full', audio: 'audio/hsk2/hsk2_吃饱.wav' },
      { hanzi: '夹', pinyin: 'jiā', meaning: 'pincer (avec baguettes)', meaningEn: 'pick up (chopsticks)', audio: 'audio/hsk5/hsk5_夹.wav' },
      { hanzi: '招待', pinyin: 'zhāodài', meaning: 'recevoir, accueillir', meaningEn: 'host, entertain', audio: 'audio/hsk5/hsk5_招待.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '收下', pinyin: 'shōuxià', meaning: 'accepter (cadeau)', meaningEn: 'accept (gift)', audio: 'audio/hsk2/hsk2_收下.wav' },
      { hanzi: '客气', pinyin: 'kèqì', meaning: 'poli, formel', meaningEn: 'polite', audio: 'audio/hsk2/hsk2_客气.wav' },
      { hanzi: '不成敬意', pinyin: 'bùchéngjìngyì', meaning: 'modeste cadeau', meaningEn: 'small token', audio: 'audio/hsk6/hsk6_敬意.wav' },
...
export const c11ConvM6LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '中间人', pinyin: 'zhōngjiānrén', meaning: 'intermédiaire', meaningEn: 'intermediary', audio: 'audio/hsk5/hsk5_中间.wav' },
      { hanzi: '关切', pinyin: 'guānqiè', meaning: 'préoccupation', meaningEn: 'concern', audio: 'audio/hsk6/hsk6_关切.wav' },
      { hanzi: '诉求', pinyin: 'sùqiú', meaning: 'demande, doléance', meaningEn: 'demand, request', audio: 'audio/hsk6/hsk6_诉求.wav' },
      { hanzi: '折中', pinyin: 'zhézhōng', meaning: 'compromis', meaningEn: 'compromise', audio: 'audio/hsk6/hsk6_折中.wav' },
      { hanzi: '诚意', pinyin: 'chéngyì', meaning: 'sincérité', meaningEn: 'sincerity', audio: 'audio/hsk5/hsk5_诚意.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '郑重', pinyin: 'zhèngzhòng', meaning: 'solennellement', meaningEn: 'solemnly', audio: 'audio/hsk6/hsk6_郑重.wav' },
      { hanzi: '推荐', pinyin: 'tuījiàn', meaning: 'recommander', meaningEn: 'recommend', audio: 'audio/hsk5/hsk5_推荐.wav' },
      { hanzi: '出色', pinyin: 'chūsè', meaning: 'excellent, remarquable', meaningEn: 'outstanding', audio: 'audio/hsk5/hsk5_出色.wav' },
      { hanzi: '价值', pinyin: 'jiàzhí', meaning: 'valeur', meaningEn: 'value', audio: 'audio/hsk5/hsk5_价值.wav' },
      { hanzi: '担保', pinyin: 'dānbǎo', meaning: 'garantir', meaningEn: 'vouch for', audio: 'audio/hsk6/hsk6_担保.wav' }
    ],
    tip:
...
export const c11ConvM7LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '若干', pinyin: 'ruògān', meaning: 'plusieurs (formel)', meaningEn: 'several (formal)', audio: 'audio/hsk5/hsk5_若干.wav' },
      { hanzi: '深思熟虑', pinyin: 'shēnsīshúlǜ', meaning: 'après mûre réflexion', meaningEn: 'careful thought', audio: 'audio/hsk6/hsk6_深思.wav' },
      { hanzi: '恳请', pinyin: 'kěnqǐng', meaning: 'demander instamment', meaningEn: 'earnestly request', audio: 'audio/hsk6/hsk6_恳请.wav' },
      { hanzi: '拨冗', pinyin: 'bōrǒng', meaning: 'prendre du temps (formel)', meaningEn: 'spare time (formal)', audio: 'audio/hsk6/hsk6_拨冗.wav' },
      { hanzi: '审阅', pinyin: 'shěnyuè', meaning: 'examiner', meaningEn: 'review', audio: 'audio/hsk6/hsk6_审阅.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '评估', pinyin: 'pínggū', meaning: 'évaluer', meaningEn: 'assess', audio: 'audio/hsk6/hsk6_评估.wav' },
      { hanzi: '入手', pinyin: 'rùshǒu', meaning: 'commencer par', meaningEn: 'start from', audio: 'audio/hsk6/hsk6_入手.wav' },
      { hanzi: '最优', pinyin: 'zuìyōu', meaning: 'optimal', meaningEn: 'optimal', audio: 'audio/hsk6/hsk6_最优.wav' }
    ],
    tip:
...
export const c11NuancesM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '坚决', pinyin: 'jiānjué', meaning: 'résolument', meaningEn: 'resolutely', audio: 'audio/hsk5/hsk5_坚决.wav' },
      { hanzi: '坚定', pinyin: 'jiāndìng', meaning: 'ferme (croyance)', meaningEn: 'firm (belief)', audio: 'audio/hsk5/hsk5_坚定.wav' },
      { hanzi: '坚强', pinyin: 'jiānqiáng', meaning: 'fort (caractère)', meaningEn: 'strong (character)', audio: 'audio/hsk5/hsk5_坚强.wav' },
      { hanzi: '信念', pinyin: 'xìnniàn', meaning: 'conviction', meaningEn: 'conviction', audio: 'audio/hsk6/hsk6_信念.wav' },
      { hanzi: '意志', pinyin: 'yìzhì', meaning: 'volonté', meaningEn: 'will', audio: 'audio/hsk6/hsk6_意志.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '学者', pinyin: 'xuézhě', meaning: 'érudit', meaningEn: 'scholar', audio: 'audio/hsk5/hsk5_学者.wav' },
      { hanzi: '不亦乐乎', pinyin: 'bùyìlèhū', meaning: 'extrêmement', meaningEn: 'extremely', audio: 'audio/hsk6/hsk6_不亦.wav' }
    ],
    tip:
...
export const c11NuancesM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '深远', pinyin: 'shēnyuǎn', meaning: 'profond (portée)', meaningEn: 'far-reaching', audio: 'audio/hsk6/hsk6_深远.wav' },
      { hanzi: '影响', pinyin: 'yǐngxiǎng', meaning: 'influence', meaningEn: 'influence', audio: 'audio/hsk3/hsk3_影响.wav' },
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '一方面', pinyin: 'yìfāngmiàn', meaning: 'd\'un côté', meaningEn: 'on one hand', audio: 'audio/hsk5/hsk5_一方面.wav' },
      { hanzi: '另一方面', pinyin: 'lìngyìfāngmiàn', meaning: 'de l\'autre côté', meaningEn: 'on the other hand', audio: 'audio/hsk5/hsk5_另.wav' }
    ],
    tip:
...
export const c11NuancesM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '根据', pinyin: 'gēnjù', meaning: 'selon', meaningEn: 'according to', audio: 'audio/hsk3/hsk3_根据.wav' },
      { hanzi: '基于', pinyin: 'jīyú', meaning: 'sur la base de', meaningEn: 'based on', audio: 'audio/hsk6/hsk6_基于.wav' },
      { hanzi: '鉴于', pinyin: 'jiànyú', meaning: 'vu que (formel)', meaningEn: 'given that', audio: 'audio/hsk6/hsk6_鉴于.wav' },
      { hanzi: '事实', pinyin: 'shìshí', meaning: 'fait', meaningEn: 'fact', audio: 'audio/hsk5/hsk5_事实.wav' },
      { hanzi: '形势', pinyin: 'xíngshì', meaning: 'situation', meaningEn: 'situation', audio: 'audio/hsk5/hsk5_形势.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '首先', pinyin: 'shǒuxiān', meaning: 'en premier', meaningEn: 'firstly', audio: 'audio/hsk3/hsk3_首先.wav' },
      { hanzi: '起初', pinyin: 'qǐchū', meaning: 'au départ', meaningEn: 'at first', audio: 'audio/hsk6/hsk6_起初.wav' },
      { hanzi: '后来', pinyin: 'hòulái', meaning: 'ensuite, plus tard', meaningEn: 'later', audio: 'audio/hsk3/hsk3_后来.wav' },
      { hanzi: '发现', pinyin: 'fāxiàn', meaning: 'découvrir', meaningEn: 'discover', audio: 'audio/hsk3/hsk3_发现.wav' }
    ],
    tip:
...
export const c11NuancesM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '从而', pinyin: 'cóngér', meaning: 'et ainsi', meaningEn: 'thereby', audio: 'audio/hsk5/hsk5_从而.wav' },
      { hanzi: '刺激', pinyin: 'cìjī', meaning: 'stimuler', meaningEn: 'stimulate', audio: 'audio/hsk5/hsk5_刺激.wav' },
      { hanzi: '消费', pinyin: 'xiāofèi', meaning: 'consommation', meaningEn: 'consumption', audio: 'audio/hsk5/hsk5_消费.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '尽管', pinyin: 'jǐnguǎn', meaning: 'bien que (réel)', meaningEn: 'although (real)', audio: 'audio/hsk4/hsk4_尽管.wav' },
      { hanzi: '即使', pinyin: 'jíshǐ', meaning: 'même si (hypothèse)', meaningEn: 'even if (hypothetical)', audio: 'audio/hsk4/hsk4_即使.wav' },
      { hanzi: '哪怕', pinyin: 'nǎpà', meaning: 'même si (extrême)', meaningEn: 'even if (extreme)', audio: 'audio/hsk6/hsk6_哪怕.wav' },
      { hanzi: '希望', pinyin: 'xīwàng', meaning: 'espoir', meaningEn: 'hope', audio: 'audio/hsk2/hsk2_希望.wav' },
      { hanzi: '尝试', pinyin: 'chángshì', meaning: 'essayer', meaningEn: 'try', audio: 'audio/hsk5/hsk5_尝试.wav' }
    ],
    tip:
...
export const c11NuancesM5LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '鼎盛', pinyin: 'dǐngshèng', meaning: 'à l\'apogée', meaningEn: 'at the peak', audio: 'audio/hsk6/hsk6_鼎盛.wav' },
      { hanzi: '时期', pinyin: 'shíqī', meaning: 'période', meaningEn: 'period', audio: 'audio/hsk5/hsk5_时期.wav' },
      { hanzi: '事业', pinyin: 'shìyè', meaning: 'carrière, entreprise', meaningEn: 'career, undertaking', audio: 'audio/hsk5/hsk5_事业.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '消亡', pinyin: 'xiāowáng', meaning: 'disparition', meaningEn: 'extinction', audio: 'audio/hsk6/hsk6_消亡.wav' },
      { hanzi: '帝国', pinyin: 'dìguó', meaning: 'empire', meaningEn: 'empire', audio: 'audio/hsk6/hsk6_帝国.wav' },
      { hanzi: '物种', pinyin: 'wùzhǒng', meaning: 'espèce', meaningEn: 'species', audio: 'audio/hsk6/hsk6_物种.wav' }
    ],
    tip:
...
export const c11NuancesM6LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '价值', pinyin: 'jiàzhí', meaning: 'valeur', meaningEn: 'value', audio: 'audio/hsk5/hsk5_价值.wav' },
      { hanzi: '意义', pinyin: 'yìyì', meaning: 'sens, signification', meaningEn: 'meaning', audio: 'audio/hsk5/hsk5_意义.wav' },
      { hanzi: '意味', pinyin: 'yìwèi', meaning: 'signifier, sous-entendre', meaningEn: 'imply', audio: 'audio/hsk6/hsk6_意味.wav' },
      { hanzi: '价值观', pinyin: 'jiàzhíguān', meaning: 'système de valeurs', meaningEn: 'value system', audio: 'audio/hsk6/hsk6_价值观.wav' },
      { hanzi: '象征', pinyin: 'xiàngzhēng', meaning: 'symboliser', meaningEn: 'symbolize', audio: 'audio/hsk6/hsk6_象征.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '影响', pinyin: 'yǐngxiǎng', meaning: 'influence', meaningEn: 'influence', audio: 'audio/hsk3/hsk3_影响.wav' },
      { hanzi: '作用', pinyin: 'zuòyòng', meaning: 'fonction, action', meaningEn: 'function, action', audio: 'audio/hsk5/hsk5_作用.wav' },
      { hanzi: '效果', pinyin: 'xiàoguǒ', meaning: 'effet, résultat', meaningEn: 'effect, result', audio: 'audio/hsk4/hsk4_效果.wav' },
      { hanzi: '镇痛', pinyin: 'zhèntòng', meaning: 'analgésique', meaningEn: 'analgesic', audio: 'audio/hsk6/hsk6_镇痛.wav' },
...
export const c11NuancesM7LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '隆重', pinyin: 'lóngzhòng', meaning: 'grandiose', meaningEn: 'grand, ceremonial', audio: 'audio/hsk5/hsk5_隆重.wav' },
      { hanzi: '承诺', pinyin: 'chéngnuò', meaning: 'engagement, promesse', meaningEn: 'commitment', audio: 'audio/hsk5/hsk5_承诺.wav' },
      { hanzi: '举行', pinyin: 'jǔxíng', meaning: 'tenir, organiser', meaningEn: 'hold (event)', audio: 'audio/hsk3/hsk3_举行.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '决议', pinyin: 'juéyì', meaning: 'résolution officielle', meaningEn: 'official resolution', audio: 'audio/hsk6/hsk6_决议.wav' },
      { hanzi: '下决心', pinyin: 'xiàjuéxīn', meaning: 'prendre la résolution', meaningEn: 'resolve to', audio: 'audio/hsk5/hsk5_下决心.wav' },
      { hanzi: '通过', pinyin: 'tōngguò', meaning: 'adopter, par', meaningEn: 'pass, by way of', audio: 'audio/hsk4/hsk4_通过.wav' }
    ],
    tip:
...
export const c11ChengyuBasicM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '成语', pinyin: 'chéngyǔ', meaning: 'expression idiomatique', meaningEn: 'idiom', audio: 'audio/hsk5/hsk5_成语.wav' },
      { hanzi: '一举两得', pinyin: 'yījǔliǎngdé', meaning: '2 en 1', meaningEn: '2-in-1', audio: 'audio/hsk6/hsk6_一举.wav' },
      { hanzi: '马到成功', pinyin: 'mǎdàochénggōng', meaning: 'succès immédiat', meaningEn: 'instant success', audio: 'audio/hsk6/hsk6_马到.wav' },
      { hanzi: '锦上添花', pinyin: 'jǐnshàngtiānhuā', meaning: 'cerise sur le gâteau', meaningEn: 'icing on the cake', audio: 'audio/hsk6/hsk6_锦上.wav' },
  ...
  },
  {
    ...
    items: [
      { hanzi: '形式', pinyin: 'xíngshì', meaning: 'forme', meaningEn: 'form', audio: 'audio/hsk5/hsk5_形式.wav' },
      { hanzi: '固定', pinyin: 'gùdìng', meaning: 'figé', meaningEn: 'fixed', audio: 'audio/hsk4/hsk4_固定.wav' },
      { hanzi: '直接', pinyin: 'zhíjiē', meaning: 'directement', meaningEn: 'directly', audio: 'audio/hsk3/hsk3_直接.wav' },
      { hanzi: '面子', pinyin: 'miànzi', meaning: 'face', meaningEn: 'face', audio: 'audio/hsk5/hsk5_面子.wav' },
      { hanzi: '场合', pinyin: 'chǎnghé', meaning: 'occasion, contexte', meaningEn: 'occasion', audio: 'audio/hsk5/hsk5_场合.wav' }
    ],
    tip:
...
export const c11ChengyuBasicM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '人山人海', pinyin: 'rénshānrénhǎi', meaning: 'foule massive', meaningEn: 'huge crowd', audio: 'audio/hsk6/hsk6_人山.wav' },
      { hanzi: '五花八门', pinyin: 'wǔhuābāmén', meaning: 'toutes sortes', meaningEn: 'all kinds', audio: 'audio/hsk6/hsk6_五花.wav' },
      { hanzi: '千变万化', pinyin: 'qiānbiànwànhuà', meaning: 'en perpétuelle évolution', meaningEn: 'constantly changing', audio: 'audio/hsk6/hsk6_千变.wav' },
      { hanzi: '春运', pinyin: 'chūnyùn', meaning: 'migration du Nouvel An', meaningEn: 'Spring Festival rush', audio: 'audio/hsk6/hsk6_春运.wav' },
  ...
  },
  {
    ...
    items: [
      { hanzi: '天壤之别', pinyin: 'tiānrǎngzhībié', meaning: 'différence énorme', meaningEn: 'world of difference', audio: 'audio/hsk6/hsk6_天壤.wav' },
      { hanzi: '不相上下', pinyin: 'bùxiāngshàngxià', meaning: 'à égalité', meaningEn: 'on a par', audio: 'audio/hsk6/hsk6_不相.wav' },
      { hanzi: '日新月异', pinyin: 'rìxīnyuèyì', meaning: 'évolution rapide', meaningEn: 'rapidly evolving', audio: 'audio/hsk6/hsk6_日新.wav' },
      { hanzi: '候选人', pinyin: 'hòuxuǎnrén', meaning: 'candidat', meaningEn: 'candidate', audio: 'audio/hsk5/hsk5_候选人.wav' },
      { hanzi: '城市', pinyin: 'chéngshì', meaning: 'ville', meaningEn: 'city', audio: 'audio/hsk2/hsk2_城市.wav' }
    ],
    tip:
...
export const c11ChengyuBasicM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '自相矛盾', pinyin: 'zìxiāngmáodùn', meaning: 'se contredire', meaningEn: 'self-contradict', audio: 'audio/hsk6/hsk6_自相.wav' },
      { hanzi: '画蛇添足', pinyin: 'huàshétiānzú', meaning: 'gâcher par excès', meaningEn: 'overdo it', audio: 'audio/hsk6/hsk6_画蛇.wav' },
      { hanzi: '论点', pinyin: 'lùndiǎn', meaning: 'argument', meaningEn: 'argument', audio: 'audio/hsk6/hsk6_论点.wav' },
      { hanzi: '似乎', pinyin: 'sìhū', meaning: 'sembler', meaningEn: 'seem', audio: 'audio/hsk5/hsk5_似乎.wav' },
      { hanzi: '修改', pinyin: 'xiūgǎi', meaning: 'modification', meaningEn: 'edit', audio: 'audio/hsk5/hsk5_修改.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '影子', pinyin: 'yǐngzi', meaning: 'ombre', meaningEn: 'shadow', audio: 'audio/hsk4/hsk4_影子.wav' },
      { hanzi: '怀疑', pinyin: 'huáiyí', meaning: 'douter, soupçonner', meaningEn: 'suspect', audio: 'audio/hsk4/hsk4_怀疑.wav' },
      { hanzi: '反应', pinyin: 'fǎnyìng', meaning: 'réaction', meaningEn: 'reaction', audio: 'audio/hsk5/hsk5_反应.wav' }
    ],
    tip:
...
export const c11ChengyuBasicM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '坚持不懈', pinyin: 'jiānchíbùxiè', meaning: 'persévérer sans relâche', meaningEn: 'persevere unyieldingly', audio: 'audio/hsk6/hsk6_坚持不懈.wav' },
      { hanzi: '勇往直前', pinyin: 'yǒngwǎngzhíqián', meaning: 'avancer courageusement', meaningEn: 'press forward', audio: 'audio/hsk6/hsk6_勇往.wav' },
      { hanzi: '言败', pinyin: 'yánbài', meaning: 'reconnaître la défaite', meaningEn: 'admit defeat', audio: 'audio/hsk6/hsk6_言.wav' },
      { hanzi: '努力', pinyin: 'nǔlì', meaning: 'effort', meaningEn: 'effort', audio: 'audio/hsk3/hsk3_努力.wav' },
      { hanzi: '激励', pinyin: 'jīlì', meaning: 'inspirer, motiver', meaningEn: 'motivate', audio: 'audio/hsk6/hsk6_激励.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '一心一意', pinyin: 'yìxīnyíyì', meaning: 'totalement dévoué', meaningEn: 'wholeheartedly', audio: 'audio/hsk6/hsk6_一心.wav' },
      { hanzi: '全神贯注', pinyin: 'quánshénguànzhù', meaning: 'totale concentration', meaningEn: 'fully focused', audio: 'audio/hsk6/hsk6_全神.wav' },
      { hanzi: '废寝忘食', pinyin: 'fèiqǐnwàngshí', meaning: 'engagement extrême', meaningEn: 'forget sleep & food', audio: 'audio/hsk6/hsk6_废寝.wav' },
      { hanzi: '照顾', pinyin: 'zhàogù', meaning: 'prendre soin', meaningEn: 'take care', audio: 'audio/hsk3/hsk3_照顾.wav' },
      { hanzi: '听讲', pinyin: 'tīngjiǎng', meaning: 'écouter (cours)', meaningEn: 'listen (lecture)', audio: 'audio/hsk5/hsk5_听讲.wav' }
    ],
    tip:
...
export const c11MediaDiscourseM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '主体', pinyin: 'zhǔtǐ', meaning: 'corps (presse)', meaningEn: 'body (press)', audio: 'audio/hsk6/hsk6_主体.wav' },
      { hanzi: '副标题', pinyin: 'fùbiāotí', meaning: 'sous-titre', meaningEn: 'subhead', audio: 'audio/hsk6/hsk6_副.wav' },
      { hanzi: '预计', pinyin: 'yùjì', meaning: 'prévoir', meaningEn: 'forecast', audio: 'audio/hsk5/hsk5_预计.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '央视', pinyin: 'yāngshì', meaning: 'CCTV (abrégé)', meaningEn: 'CCTV', audio: 'audio/hsk6/hsk6_央视.wav' },
      { hanzi: '新闻联播', pinyin: 'xīnwénliánbō', meaning: 'JT du soir CCTV', meaningEn: 'evening news', audio: 'audio/hsk6/hsk6_新闻联播.wav' },
      { hanzi: '财新', pinyin: 'cáixīn', meaning: 'Caixin', meaningEn: 'Caixin', audio: 'audio/hsk6/hsk6_财新.wav' }
    ],
    tip:
...
export const c11MediaDiscourseM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '发展', pinyin: 'fāzhǎn', meaning: 'développement', meaningEn: 'development', audio: 'audio/hsk4/hsk4_发展.wav' },
      { hanzi: '邓小平', pinyin: 'dèngxiǎopíng', meaning: 'Deng Xiaoping', meaningEn: 'Deng Xiaoping', audio: 'audio/hsk6/hsk6_邓小平.wav' },
      { hanzi: '深圳', pinyin: 'shēnzhèn', meaning: 'Shenzhen', meaningEn: 'Shenzhen', audio: 'audio/hsk5/hsk5_深圳.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '中国梦', pinyin: 'zhōngguó mèng', meaning: 'Rêve chinois', meaningEn: 'Chinese Dream', audio: 'audio/hsk6/hsk6_中国梦.wav' },
      { hanzi: '一带一路', pinyin: 'yīdài yīlù', meaning: 'Belt and Road', meaningEn: 'Belt and Road', audio: 'audio/hsk6/hsk6_一带.wav' },
      { hanzi: '共同富裕', pinyin: 'gòngtóngfùyù', meaning: 'prospérité commune', meaningEn: 'common prosperity', audio: 'audio/hsk6/hsk6_共同.wav' },
...
export const c11MediaDiscourseM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '中方', pinyin: 'zhōngfāng', meaning: 'partie chinoise', meaningEn: 'Chinese side', audio: 'audio/hsk6/hsk6_中方.wav' },
      { hanzi: '双边', pinyin: 'shuāngbiān', meaning: 'bilatéral', meaningEn: 'bilateral', audio: 'audio/hsk6/hsk6_双边.wav' },
      { hanzi: '多边', pinyin: 'duōbiān', meaning: 'multilatéral', meaningEn: 'multilateral', audio: 'audio/hsk6/hsk6_多边.wav' },
      { hanzi: '伙伴', pinyin: 'huǒbàn', meaning: 'partenaire', meaningEn: 'partner', audio: 'audio/hsk5/hsk5_伙伴.wav' },
      { hanzi: '战略', pinyin: 'zhànlüè', meaning: 'stratégique', meaningEn: 'strategic', audio: 'audio/hsk5/hsk5_战略.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '台湾', pinyin: 'táiwān', meaning: 'Taïwan', meaningEn: 'Taiwan', audio: 'audio/hsk5/hsk5_台湾.wav' },
      { hanzi: '香港', pinyin: 'xiānggǎng', meaning: 'Hong Kong', meaningEn: 'Hong Kong', audio: 'audio/hsk4/hsk4_香港.wav' },
      { hanzi: '南海', pinyin: 'nánhǎi', meaning: 'Mer de Chine méridionale', meaningEn: 'South China Sea', audio: 'audio/hsk6/hsk6_南海.wav' },
      { hanzi: '原则', pinyin: 'yuánzé', meaning: 'principe', meaningEn: 'principle', audio: 'audio/hsk5/hsk5_原则.wav' },
      { hanzi: '领土', pinyin: 'lǐngtǔ', meaning: 'territoire', meaningEn: 'territory', audio: 'audio/hsk6/hsk6_领土.wav' }
    ],
    tip:
...
export const c11MediaDiscourseM4LearnSections: LessonV2LearnSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '然而', pinyin: 'ránér', meaning: 'toutefois', meaningEn: 'however', audio: 'audio/hsk5/hsk5_然而.wav' },
      { hanzi: '纵使', pinyin: 'zòngshǐ', meaning: 'même si (formel)', meaningEn: 'even if (formal)', audio: 'audio/hsk6/hsk6_纵使.wav' },
      { hanzi: '倘若', pinyin: 'tǎngruò', meaning: 'si jamais', meaningEn: 'should (if)', audio: 'audio/hsk6/hsk6_倘若.wav' },
...
export const c11HistoryM1LearnSections: LessonV2LearnSection[] = [
  ...
  },
  {
    ...
    items: [
      { hanzi: '秦始皇', pinyin: 'qínshǐhuáng', meaning: 'Premier Empereur', meaningEn: 'First Emperor', audio: 'audio/hsk6/hsk6_秦始皇.wav' },
      { hanzi: '张骞', pinyin: 'zhāngqiān', meaning: 'Zhang Qian', meaningEn: 'Zhang Qian', audio: 'audio/hsk6/hsk6_张骞.wav' },
      { hanzi: '李白', pinyin: 'lǐbái', meaning: 'Li Bai', meaningEn: 'Li Bai', audio: 'audio/hsk5/hsk5_李白.wav' },
      { hanzi: '武则天', pinyin: 'wǔzétiān', meaning: 'Wu Zetian', meaningEn: 'Wu Zetian', audio: 'audio/hsk6/hsk6_武则天.wav' },
      { hanzi: '郑和', pinyin: 'zhènghé', meaning: 'Zheng He', meaningEn: 'Zheng He', audio: 'audio/hsk6/hsk6_郑和.wav' }
    ],
    tip:
...
export const c11HistoryM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '辛亥革命', pinyin: 'xīnhàigémìng', meaning: 'Révolution Xinhai', meaningEn: 'Xinhai Revolution', audio: 'audio/hsk6/hsk6_辛亥.wav' },
      { hanzi: '孙中山', pinyin: 'sūnzhōngshān', meaning: 'Sun Yat-sen', meaningEn: 'Sun Yat-sen', audio: 'audio/hsk6/hsk6_孙中山.wav' },
      { hanzi: '中华人民共和国', pinyin: 'zhōnghuárénmíngònghéguó', meaning: 'République populaire', meaningEn: 'PRC', audio: 'audio/hsk6/hsk6_中华.wav' },
      { hanzi: '邓小平', pinyin: 'dèngxiǎopíng', meaning: 'Deng Xiaoping', meaningEn: 'Deng Xiaoping', audio: 'audio/hsk6/hsk6_邓小平.wav' },
      { hanzi: '改革开放', pinyin: 'gǎigékāifàng', meaning: 'Réforme et Ouverture', meaningEn: 'Reform & Opening', audio: 'audio/hsk6/hsk6_改革开放.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '大跃进', pinyin: 'dàyuèjìn', meaning: 'Grand Bond en avant', meaningEn: 'Great Leap Forward', audio: 'audio/hsk6/hsk6_大跃进.wav' },
      { hanzi: '文革', pinyin: 'wéngé', meaning: 'Révolution culturelle (abrégé)', meaningEn: 'Cultural Revolution', audio: 'audio/hsk6/hsk6_文革.wav' },
      { hanzi: '红卫兵', pinyin: 'hóngwèibīng', meaning: 'Gardes rouges', meaningEn: 'Red Guards', audio: 'audio/hsk6/hsk6_红卫兵.wav' },
      { hanzi: '特殊', pinyin: 'tèshū', meaning: 'particulier, spécial', meaningEn: 'special', audio: 'audio/hsk5/hsk5_特殊.wav' },
      { hanzi: '时期', pinyin: 'shíqī', meaning: 'période', meaningEn: 'period', audio: 'audio/hsk5/hsk5_时期.wav' }
    ],
    tip:
...
export const c11HistoryM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      ...
      { hanzi: '西游记', pinyin: 'xīyóujì', meaning: 'Pérégrination vers l\'Ouest', meaningEn: 'Journey to West', audio: 'audio/hsk6/hsk6_西游记.wav' },
      { hanzi: '红楼梦', pinyin: 'hónglóumèng', meaning: 'Rêve dans le pavillon rouge', meaningEn: 'Dream of Red Chamber', audio: 'audio/hsk6/hsk6_红楼梦.wav' },
      { hanzi: '孙悟空', pinyin: 'sūnwùkōng', meaning: 'Roi Singe', meaningEn: 'Monkey King', audio: 'audio/hsk5/hsk5_孙悟空.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '桃园', pinyin: 'táoyuán', meaning: 'verger de pêchers', meaningEn: 'peach orchard', audio: 'audio/hsk6/hsk6_桃园.wav' },
      { hanzi: '结义', pinyin: 'jiéyì', meaning: 'fraternité jurée', meaningEn: 'sworn brotherhood', audio: 'audio/hsk6/hsk6_结义.wav' },
      { hanzi: '大闹', pinyin: 'dànào', meaning: 'semer le chaos', meaningEn: 'wreak havoc', audio: 'audio/hsk6/hsk6_大闹.wav' },
      { hanzi: '天宫', pinyin: 'tiāngōng', meaning: 'palais céleste', meaningEn: 'celestial palace', audio: 'audio/hsk6/hsk6_天宫.wav' },
      { hanzi: '葬花', pinyin: 'zànghuā', meaning: 'enterrer des fleurs', meaningEn: 'bury flowers', audio: 'audio/hsk6/hsk6_葬花.wav' }
    ],
    tip:
...
export const c11HistoryM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '丝绸之路', pinyin: 'sīchóuzhīlù', meaning: 'Route de la Soie', meaningEn: 'Silk Road', audio: 'audio/hsk6/hsk6_丝绸.wav' },
      { hanzi: '长安', pinyin: 'chángān', meaning: 'Chang\'an', meaningEn: 'Chang\'an', audio: 'audio/hsk5/hsk5_长安.wav' },
      { hanzi: '敦煌', pinyin: 'dūnhuáng', meaning: 'Dunhuang', meaningEn: 'Dunhuang', audio: 'audio/hsk6/hsk6_敦煌.wav' },
      { hanzi: '莫高窟', pinyin: 'mògāokū', meaning: 'grottes de Mogao', meaningEn: 'Mogao Caves', audio: 'audio/hsk6/hsk6_莫高.wav' },
      { hanzi: '喀什', pinyin: 'kāshí', meaning: 'Kashgar', meaningEn: 'Kashgar', audio: 'audio/hsk6/hsk6_喀什.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '一带一路', pinyin: 'yīdài yīlù', meaning: 'Belt and Road', meaningEn: 'Belt and Road', audio: 'audio/hsk6/hsk6_一带.wav' },
      { hanzi: '基础设施', pinyin: 'jīchǔshèshī', meaning: 'infrastructure', meaningEn: 'infrastructure', audio: 'audio/hsk6/hsk6_基础.wav' },
      { hanzi: '投资', pinyin: 'tóuzī', meaning: 'investissement', meaningEn: 'investment', audio: 'audio/hsk5/hsk5_投资.wav' },
      { hanzi: '合作', pinyin: 'hézuò', meaning: 'coopération', meaningEn: 'cooperation', audio: 'audio/hsk4/hsk4_合作.wav' },
...
export const c11StyleFormalM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '尊敬', pinyin: 'zūnjìng', meaning: 'respecté', meaningEn: 'esteemed', audio: 'audio/hsk5/hsk5_尊敬.wav' },
      ...
      { hanzi: '安好', pinyin: 'ānhǎo', meaning: 'bien portant', meaningEn: 'well', audio: 'audio/hsk6/hsk6_安好.wav' },
  ...
  },
  {
    ...
    items: [
      { hanzi: '此致', pinyin: 'cǐzhì', meaning: 'par la présente', meaningEn: 'hereby', audio: 'audio/hsk6/hsk6_此致.wav' },
      { hanzi: '敬礼', pinyin: 'jìnglǐ', meaning: 'salutation respectueuse', meaningEn: 'respectful salute', audio: 'audio/hsk6/hsk6_敬礼.wav' },
      { hanzi: '敬上', pinyin: 'jìng shàng', meaning: 'respectueusement', meaningEn: 'respectfully yours', audio: 'audio/hsk6/hsk6_敬上.wav' },
      { hanzi: '顺颂商祺', pinyin: 'shùnsòng shāngqí', meaning: 'vœux d\'affaires', meaningEn: 'business prosperity wish', audio: 'audio/hsk6/hsk6_顺颂.wav' },
...
export const c11StyleFormalM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '简历', pinyin: 'jiǎnlì', meaning: 'CV', meaningEn: 'CV', audio: 'audio/hsk6/hsk6_简历.wav' },
      { hanzi: '个人信息', pinyin: 'gèrénxìnxī', meaning: 'infos personnelles', meaningEn: 'personal info', audio: 'audio/hsk5/hsk5_个人.wav' },
      { hanzi: '教育背景', pinyin: 'jiàoyù bèijǐng', meaning: 'formation', meaningEn: 'education', audio: 'audio/hsk5/hsk5_教育.wav' },
      { hanzi: '工作经验', pinyin: 'gōngzuò jīngyàn', meaning: 'expérience', meaningEn: 'experience', audio: 'audio/hsk4/hsk4_经验.wav' },
      { hanzi: '自我评价', pinyin: 'zìwǒ píngjià', meaning: 'auto-évaluation', meaningEn: 'self-eval', audio: 'audio/hsk6/hsk6_评价.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      { hanzi: '求职信', pinyin: 'qiúzhíxìn', meaning: 'lettre de motivation', meaningEn: 'cover letter', audio: 'audio/hsk6/hsk6_求职.wav' },
      { hanzi: '招聘', pinyin: 'zhāopìn', meaning: 'recruter', meaningEn: 'recruit', audio: 'audio/hsk5/hsk5_招聘.wav' },
      { hanzi: '入职', pinyin: 'rùzhí', meaning: 'prendre ses fonctions', meaningEn: 'start work', audio: 'audio/hsk6/hsk6_入职.wav' },
      { hanzi: '期待', pinyin: 'qīdài', meaning: 'attendre avec impatience', meaningEn: 'look forward to', audio: 'audio/hsk5/hsk5_期待.wav' },
      { hanzi: '回复', pinyin: 'huífù', meaning: 'réponse', meaningEn: 'reply', audio: 'audio/hsk5/hsk5_回复.wav' }
    ],
    tip:
...
export const c11StyleFormalM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    items: [
      { hanzi: '盛情', pinyin: 'shèngqíng', meaning: 'chaleureuse intention', meaningEn: 'warm hospitality', audio: 'audio/hsk6/hsk6_盛情.wav' },
      { hanzi: '款待', pinyin: 'kuǎndài', meaning: 'recevoir, accueillir', meaningEn: 'host, entertain', audio: 'audio/hsk6/hsk6_款待.wav' },
      { hanzi: '相聚', pinyin: 'xiāngjù', meaning: 'se réunir', meaningEn: 'gather', audio: 'audio/hsk6/hsk6_相聚.wav' },
      { hanzi: '提议', pinyin: 'tíyì', meaning: 'proposer', meaningEn: 'propose', audio: 'audio/hsk6/hsk6_提议.wav' },
      { hanzi: '蒸蒸日上', pinyin: 'zhēngzhēngrìshàng', meaning: 'en plein essor', meaningEn: 'thriving', audio: 'audio/hsk6/hsk6_蒸蒸.wav' }
    ],
    tip:
  ...
  },
  {
    ...
    items: [
      ...
      { hanzi: '一帆风顺', pinyin: 'yīfānfēngshùn', meaning: 'bon vent', meaningEn: 'smooth sailing', audio: 'audio/hsk6/hsk6_一帆.wav' },
      { hanzi: '万事如意', pinyin: 'wànshìrúyì', meaning: 'que tout vous soit favorable', meaningEn: 'all wishes come true', audio: 'audio/hsk6/hsk6_万事.wav' },
      { hanzi: '健康', pinyin: 'jiànkāng', meaning: 'santé', meaningEn: 'health', audio: 'audio/hsk3/hsk3_健康.wav' }
    ],
    tip:
