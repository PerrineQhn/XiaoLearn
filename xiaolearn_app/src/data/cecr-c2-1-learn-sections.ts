...
export const c21ConvM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Ouvrir : 各位学者，今天我想就 X 这一议题展开论述 (chers chercheurs, aujourd\'hui je vais développer le thème X). Vocab philosophique : 论述 (lùnshù, exposer), 阐释 (chǎnshì, élucider), 释义 (shìyì, exégèse), 注疏 (zhùshū, commentaire classique). Citation : 朱熹《四书章句集注》中说 X (selon Zhu Xi dans ses Commentaires des Quatre Livres). Cadrer une thèse : 我的论点可概括为以下几点 (mon argument peut se résumer en plusieurs points). Conclure : 此乃笔者之拙见，敬请各位斧正 (ceci est l\'humble vue de l\'auteur, merci de vos corrections).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Citation directe : 《论语》有云：« X » (les Entretiens disent : X). 《道德经》第 X 章曰 : Y (le chap. X du Daode jing dit Y). Verbes de citation : 云 (yún, dit — classique), 曰 (yuē, dit — très classique), 据载 (jùzǎi, selon les annales), 古书云 (les anciens textes disent). Pour interpréter : 此言之意 (le sens de cette parole), 这句话提示我们 X (cette phrase nous suggère X). Pour appliquer : 这句古训放在今天依然有现实意义 (cet enseignement antique reste pertinent aujourd\'hui). Combo soutenu : 古训 + 现实意义 = passerelle entre classique et contemporain, valorisée en académique chinois.',
    bodyEn:
...
export const c21ConvM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Cadre : on discute la valeur d\'une œuvre (roman, poésie, film) avec un critique chinois. Vocab : 文学价值 (valeur littéraire), 艺术成就 (accomplissement artistique), 主题深度 (profondeur thématique), 笔触 (bǐchù, touche/style narratif). Position : 我个人认为这部作品的核心价值在于 X (le cœur de cette œuvre est X). Désaccord élégant : 我对您的看法有些不同，我认为 X 反而是 Y (j\'ai un point de vue un peu différent — X est plutôt Y). Combo de réfutation soutenue : 诚然 X，然而 Y (concession + reprise — formule C1+ qui marque la rhétorique soutenue). Conclure : 文学评论本就见仁见智 (la critique littéraire est par nature subjective — formule consensuelle pour clore poliment).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Recommandation : 我向您推荐 X，作者是 Y (je vous recommande X, de l\'auteur Y). Situer dans une école : 这部作品属于 X 流派 (cette œuvre relève de l\'école X). Écoles littéraires chinoises : 朦胧诗派 (méng lóng shī pài, poésie obscure), 寻根派 (xún gēn pài, école de la quête des racines), 先锋派 (xiān fēng pài, avant-garde). Auteurs majeurs C2 : 莫言 (Mo Yan, Nobel 2012), 余华 (Yu Hua, 活着), 阎连科 (Yan Lianke), 王小波 (Wang Xiaobo). Justifier : 这部作品的价值在于 X (la valeur de cette œuvre tient à X). Effet : 读后令人深思 (lecture qui pousse à réfléchir). Précaution : 当然，每个读者的感受可能不同 (bien sûr, chaque lecteur peut ressentir différemment).',
    bodyEn:
...
export const c21ConvM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Cadre : on travaille avec un éditeur sur la traduction d\'une œuvre. Vocab : 翻译 (traduction), 译者 (traducteur), 原文 (texte source), 译文 (texte cible), 直译 (zhíyì, traduction littérale) vs 意译 (yìyì, traduction libre). Pour défendre un choix : 我倾向于意译，因为直译会损失 X 的意境 (je penche pour la traduction libre car le littéral perdrait X). 意境 (yìjìng, atmosphère/ambiance poétique) est UN MOT CLÉ chinois — INTRADUISIBLE strictement. Pour discuter : 这个词在中文里有 X 层含义，您建议如何处理 ? (ce mot a X couches en chinois, comment le rendre ?). Conclure : 翻译本就是一种再创作 (la traduction est par nature une RECRÉATION) — formule classique attribuée à Yan Fu (严复).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Étapes : (1) lire à voix haute, (2) compter les caractères/vers (5 ou 7), (3) repérer les rimes, (4) identifier les images-clés, (5) restituer. Vocab : 五言 (vers à 5 caractères), 七言 (vers à 7), 平仄 (píng zè, tons plats vs obliques — règle métrique), 对仗 (duìzhàng, parallélisme). Discussion : 这首诗的核心意象是什么 ? (quelle est l\'image centrale ?). Pour le rendre : 我们可以保留原文的对仗结构，但调整字数 (gardons le parallélisme, ajustons le nombre de mots). Phrase de méthode : 译诗须传神，不必拘泥于字面 (traduire un poème = transmettre l\'esprit, pas s\'attacher à la lettre). 传神 (chuánshén, transmettre l\'esprit) est un mot-clé.',
    bodyEn:
...
export const c21ConvM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Cadre : un Chinois te demande conseil sur un choix éthique. Tu mobilises une pensée classique. Vocab : 道 (dào, voie/principe), 德 (dé, vertu), 仁 (rén, humanité confucéenne), 义 (yì, justice/devoir), 中庸 (zhōngyōng, juste milieu). Phrase : 在我看来，您面临的是一个 X 的问题 (à mon avis, vous faites face à un problème X). Citer : 孔子曰 X / 老子说 X. Appliquer : 这个智慧告诉我们 X (cette sagesse nous dit X). Recommandation : 我建议您从 X 的角度看 (envisagez cela sous l\'angle X). Important : 但最终的选择还是在您自己 (la décision finale vous revient). Le respect de l\'AUTONOMIE est confucéen — le sage CONSEILLE, ne DÉCIDE pas pour autrui.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Cadre : on discute la pertinence du confucianisme aujourd\'hui (dans l\'éducation, le management, la politique chinoise). Position pro : 孔子的思想至今仍有现实意义 (la pensée de Confucius garde une pertinence actuelle), notamment 仁 (humanité), 礼 (rites/courtoisie), 学而时习之 (apprendre et pratiquer régulièrement). Position critique : 但有些观念已不适合现代社会 (certaines notions ne s\'adaptent plus à la société moderne), comme 三纲五常 (les 3 liens et 5 vertus, hiérarchies anciennes). Synthèse : 我认为可以批判地继承传统 (je crois qu\'on peut hériter de la tradition de manière critique). 批判地继承 (hériter de manière critique) est une formule maoïste devenue passe-partout pour discuter le patrimoine.',
    bodyEn:
...
export const c21ConvM5LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Cadre : tu es interviewé en tant qu\'auteur / chercheur. Phrases-clés : 这次的写作灵感来自 X (cette écriture est inspirée de X). 灵感 (línggǎn, inspiration). Décrire le processus : 我前后修改了 X 次 (j\'ai retravaillé X fois). 我用了 X 年完成这部作品. Pour le sens profond : 我想表达的核心思想是 X (l\'idée centrale que je veux transmettre est X). Quand on te demande des projets : 目前正在构思下一部作品 (je suis en train de concevoir la suivante). 构思 (gòusī, concevoir, réfléchir au plan) est très soutenu pour parler d\'une œuvre en gestation. Conclure modestement : 希望读者能从中获得一些启示 (j\'espère que le lecteur en tirera quelques enseignements).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Ouvrir : 各位书友，大家好 (chers amis lecteurs). 书友 (shūyǒu, ami du livre) est très chaleureux. Lancer la discussion : 这本书最让您印象深刻的是什么 ? (qu\'est-ce qui vous a le plus marqué ?). Inviter chacun : 请每位都分享一下 (que chacun partage). Synthétiser : 大家提到了几个共同的主题 X (vous avez tous mentionné les thèmes X). Pour relancer : 但也有一个细节我们没有讨论，那就是 X (un détail qu\'on n\'a pas discuté est X). Conclure : 谢谢大家的精彩分享，下次我们读 X (merci pour ces partages, la prochaine fois X). Ton : convivial mais structuré. Le 书友 chinois apprécie qu\'un animateur DESSINE des connexions entre les interventions.',
    bodyEn:
...
export const c21ConvM6LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Figures de style chinoises : 比喻 (bǐyù, métaphore — 像 X 一样), 夸张 (kuāzhāng, hyperbole — 三千丈白发), 对偶 (duì\'ǒu, parallélisme — 风调雨顺), 排比 (páibǐ, anaphore — 我们要 X，要 Y，要 Z), 反问 (fǎnwèn, question rhétorique — 难道不是吗 ?). En oral C2, mobiliser une figure de style soutient l\'argument et marque le LETTRÉ. Ex : « 教育之于一个民族，犹如水之于鱼 » (l\'éducation pour une nation est comme l\'eau pour le poisson) — 比喻 + 之于…犹如. Phrase de conclusion oratoire : 时不我待 (le temps ne nous attend pas — chengyu). 时不我待，让我们行动起来 = mobilisation puissante.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Cadre : on rend hommage à un mentor, un parent, un collègue. Vocab : 悼念 (dàoniàn, commémorer/pleurer), 追忆 (zhuīyì, se remémorer), 缅怀 (miǎnhuái, honorer la mémoire — TRÈS soutenu). Ouverture : 今天，我们怀着沉痛的心情悼念 X (aujourd\'hui, le cœur lourd, nous commémorons X). 沉痛 (chéntòng, douleur profonde) est OBLIGATOIRE en éloge funèbre. Évoquer la vie : X 一生致力于 Y (X a consacré sa vie à Y). Citer une vertu : X 的 Z 精神将激励我们继续前行 (l\'esprit Z de X nous inspirera à continuer). Conclure : 安息吧，我们永远怀念您 (reposez en paix, nous nous souviendrons toujours de vous). 安息 (ānxī, reposer en paix) est l\'expression consacrée.',
    bodyEn:
...
export const c21ConvM7LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Structure : 引言 → 文献综述 → 论点 → 论证 → 反驳潜在异议 → 结论 → 参考文献. Phrases d\'ouverture : 自古以来，X 一直是一个重要的话题 (depuis toujours, X est un sujet important). 据笔者所知 (à la connaissance de l\'auteur). Pour la thèse : 本文的核心论点是 X (la thèse centrale est X). Argumenter : 第一，X 表明 Y / 进一步而言，Z. Anticiper : 有人或许会反驳说 X，但 Y. Conclure : 综上所述，本文得出 X 的结论 / 这一发现对 Y 具有重要意义. Tone : DENSE, IMPERSONNEL, ARGUMENTATIF. Pas de « 我 » → 笔者 ou « 本研究 ». Évite les chengyu trop fleuris (réservés à la création littéraire) — l\'essai académique privilégie la PRÉCISION.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Cadre : tu rédiges un avis pour une revue académique chinoise. Vocab : 同行评议 (tóngháng píngyì, peer review), 录用 (lùyòng, accepter), 修改后录用 (accepter sous réserve de révision), 拒稿 (jùgǎo, rejeter). Phrases-types positives : 本文选题新颖 (sujet original), 论证严密 (argumentation rigoureuse), 文献丰富 (bibliographie riche). Critiques constructives : 第二部分的论证略显薄弱 (la 2e partie est un peu faible), 建议作者补充 X (l\'auteur devrait compléter X). Conclure : 总体而言，本文具有较高的学术价值，建议修改后录用 (globalement, valeur académique notable, accepter sous condition). Ton : RIGUEUR + RESPECT pour le travail. Évite SAR-CASME ou jugement personnel.',
    bodyEn:
...
export const c21NuancesM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '道 (dào) = la VOIE / le principe métaphysique. Chez les confucéens : la voie morale juste. Chez Lao Zi : le principe ultime de l\'univers, INNOMMABLE (« 道可道，非常道 » — le dao qu\'on peut nommer n\'est pas le vrai dao). 德 (dé) = la VERTU intériorisée, la qualité morale active dans la personne. 道德 (morale) = combinaison des deux : le principe + la vertu vécue. 礼 (lǐ) = les RITES, l\'étiquette sociale qui matérialise la vertu. 礼仪 (lǐyí, rites et étiquette). Hierarchy fonctionnelle : 道 (principe abstrait) → 德 (vertu intériorisée) → 礼 (rite extérieur). Confucius : sans 德, le 礼 est vide ; sans 礼, le 德 est invisible. Triade indissociable de la pensée chinoise.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '仁 (rén, humanité, bienveillance) = vertu CARDINALE de Confucius. « 仁者爱人 » (l\'humain bienveillant aime les autres). Le 仁 est la base de tout. 义 (yì, justice/devoir) = ce qu\'on DOIT faire selon le bien moral. 见义勇为 (voir le juste et oser agir). Souvent au-delà du gain personnel. 信 (xìn, foi/fiabilité) = tenir parole. 信用 (crédit moral). Forme avec 仁义礼智信 les 五常 (5 vertus cardinales) qui structurent l\'éthique confucéenne. Hierarchy : 仁 (sentiment d\'humanité), 义 (devoir moral), 礼 (rites sociaux), 智 (sagesse pratique), 信 (fidélité à la parole). Tout débat éthique chinois mobilise ces 5 mots — les maîtriser ouvre la pensée.',
    bodyEn:
...
export const c21NuancesM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '阴 (yīn) = principe FÉMININ, sombre, froid, intérieur, terre, lune, eau. 阳 (yáng) = principe MASCULIN, lumineux, chaud, extérieur, ciel, soleil, feu. Pas un dualisme statique — un FLUX (太极图 : symbole du Tao avec 1 point de chaque couleur dans l\'autre). 五行 (wǔxíng, 5 phases) : 木 (bois) → 火 (feu) → 土 (terre) → 金 (métal) → 水 (eau). Cycles : 相生 (engendrement : bois→feu→terre→métal→eau→bois) et 相克 (domination : bois→terre→eau→feu→métal→bois). Cette cosmologie structure médecine traditionnelle, fengshui, calendrier, et nomenclature classique. Connaître ces termes débloque la lecture de TOUT texte traditionnel chinois.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '诗 (shī) = POÉSIE classique régulière (Tang surtout). Vers de 5 ou 7 caractères, rimes strictes, parallélisme rigoureux. Ex : 李白, 杜甫. 词 (cí) = POÉSIE chantée Song, sur des MÉLODIES préexistantes (词牌 — modèles métriques). Vers de longueurs variables. Plus libre que 诗 mais structuré par la musique. Ex : 苏轼, 李清照. 曲 (qǔ) = POÉSIE-théâtre Yuan, mélanges chant + récit. Encore plus libre. Ex : 关汉卿. Hierarchy : 诗 (Tang, vers fixes) → 词 (Song, sur mélodie) → 曲 (Yuan, théâtral). Confondre les 3 = erreur grave en discussion littéraire chinoise. Une phrase comme « 李清照写的词 » est juste ; « 李清照的诗 » est techniquement faux.',
    bodyEn:
...
export const c21NuancesM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '中庸 (zhōngyōng) = LE JUSTE MILIEU CONFUCÉEN. Pas la moyenne fade, mais la vertu d\'éviter les extrêmes par sagesse. Œuvre : 《中庸》, l\'un des Quatre Livres. 中立 (zhōnglì) = NEUTRALITÉ politique/diplomatique. 保持中立 (rester neutre). Connote refus de prendre parti. 中间 (zhōngjiān) = MILIEU SPATIAL ou TEMPOREL (au centre, entre 2 choses). 中间人 (intermédiaire). Plus concret. Hierarchy conceptuelle : 中庸 (vertu morale) ≠ 中立 (position politique) ≠ 中间 (position physique/temporelle). Confondre 中庸 et 中立 = erreur philosophique. Le 中庸 IMPLIQUE un jugement actif sur le bien ; le 中立 est une ABSTENTION.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '天下 (tiānxià) = « TOUT-SOUS-LE-CIEL » — concept impérial chinois englobant l\'ensemble du monde civilisé sous l\'autorité morale du Fils du Ciel. Ne se réduit pas à l\'État moderne. 天下兴亡，匹夫有责 (chacun a la responsabilité du sort du monde — 顾炎武, célèbre maxime). 国家 (guójiā) = ÉTAT-NATION moderne, entité politique-juridique. Concept westphalien adopté à la fin du XIXe. 民族 (mínzú) = NATION ETHNIQUE/peuple. La Chine moderne se définit comme un 多民族国家 (État multi-ethnique avec 56 ethnies reconnues). La distinction 天下 / 国家 / 民族 structure tout débat sur l\'identité chinoise. 天下 = vision impériale ; 国家 = vision moderne ; 民族 = identité culturelle.',
    bodyEn:
...
export const c21NuancesM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '言 (yán) = parler / la parole. Verbe et nom en chinois classique. Reste vivant : 言论 (discours), 言行 (paroles et actes), 名言 (citation célèbre). « 言之有理 » (avoir raison dans ses paroles). 而 (ér) = ET / ALORS / MAIS — connecteur classique TRÈS productif. « 学而时习之 » (apprendre et le pratiquer régulièrement — première phrase des Entretiens). « 不亦乐乎 » (n\'est-ce pas joyeux ?). Reste dans 而且, 然而, 进而. 于 (yú) = à / dans / par rapport à — préposition classique. « 出于 X » (provenir de X), « 关于 X » (concernant X), « 至于 X » (quant à X), « 由于 X » (à cause de X). Maîtriser ces 3 particules débloque la lecture des Entretiens, du Mencius, et de tout texte classique.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '是非 (shìfēi) = LE VRAI ET LE FAUX (axe ÉPISTÉMIQUE — ce qui est VRAI factuellement). 明辨是非 (distinguer clairement le vrai du faux). Connote la rigueur intellectuelle. 善恶 (shàn\'è) = LE BIEN ET LE MAL (axe MORAL — qualités intérieures). 善有善报，恶有恶报 (le bien attire le bien, le mal attire le mal — karma). Connote l\'éthique profonde. 对错 (duìcuò) = JUSTE ET ERRONÉ (axe PRAGMATIQUE — ce qui est correct dans une action). 对错很重要 (ce qui est juste compte). Plus quotidien et concret. Hierarchy : 对错 (concret action) < 是非 (épistémique fait) < 善恶 (moral profond). Erreur classique : confondre 是非 (vérité) et 善恶 (moralité) — un fait peut être 是 mais 恶.',
    bodyEn:
      '是非 (shìfēi) = TRUE AND FALSE (EPISTEMIC axis — what is factually TRUE). 明辨是非 (clearly distinguish true from false). Connotes intellectual rigor. 善恶 (shàn\'è) = GOOD AND EVIL (MORAL axis — inner qualities). 善有善报，恶有恶报 (good attracts good, evil attracts evil — karma). Connotes deep ethics. 对错 (duìcuò) = RIGHT AND WRONG (PRAGMATIC axis — what\'s correct in action). 对错很重要 (right vs wrong matters). More everyday and concrete. Hierarchy: 对错 (concrete action) < 是非 (epistemic fact) < 善恶 (deep moral). Classic mistake: confusing 是非 (truth) and 善恶 (morality) — a fact may be 是 but 恶.',
    items: [
...
export const c21NuancesM5LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '身 (shēn) = CORPS PHYSIQUE. 身体 (corps), 身材 (silhouette). Le matériel. 心 (xīn) = CŒUR/ESPRIT-CŒUR. En chinois, le 心 EST le siège de la pensée ET du sentiment (pas séparés comme en Occident). 心情 (humeur), 心思 (pensée), 关心 (se soucier de). 灵 (líng) = ÂME, esprit subtil. 灵魂 (âme), 心灵 (esprit-cœur, au sens spirituel). Plus rare et soutenu. 神 (shén) = ESPRIT divin / éclat / aspect divin de l\'humain. 精神 (esprit, vivacité), 神采 (éclat), 神圣 (sacré). Hierarchy : 身 (corps physique) < 心 (cœur-esprit pensant) < 灵 (âme spirituelle) < 神 (divin). En chinois, l\'absence de séparation cœur/raison est centrale — tout débat avec une personne instruite passe par la compréhension de 心.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '天 (tiān) = CIEL — le principe céleste, source du mandat moral (天命). « 天命所归 » (le mandat céleste est attribué à X). Connote la PROVIDENCE ou le destin. 地 (dì) = TERRE — le principe matériel, qui nourrit. « 大地 » (la grande terre, la nature). Connote la STABILITÉ, le SUPPORT. 人 (rén) = HUMAIN — le principe médian entre Ciel et Terre. La pensée chinoise place l\'humain comme MÉDIATEUR cosmologique. « 三才 » (les 3 puissances : 天地人) est un concept fondamental. L\'humain idéal HARMONISE le Ciel et la Terre. « 天时地利人和 » (chengyu : le moment du ciel, l\'avantage de la terre, l\'harmonie humaine — 3 conditions du succès). À mobiliser pour analyser une réussite.',
    bodyEn:
...
export const c21NuancesM6LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '意境 (yìjìng) = ATMOSPHÈRE POÉTIQUE / ambiance d\'une œuvre artistique chinoise. INTRADUISIBLE strictement — fusion de l\'image (意) et du décor (境) qui crée une émotion profonde. Concept central de l\'esthétique chinoise. 氛围 (fēnwéi) = AMBIANCE générale (lieu, événement, conversation). 节日的氛围 (l\'ambiance d\'une fête). Plus universel et social. 风格 (fēnggé) = STYLE (artistique, personnel, vestimentaire). 这位画家的风格 (le style de ce peintre). Plus formel sur l\'identité créative. Hierarchy : 氛围 (ambiance générale) < 风格 (identité artistique) < 意境 (concept esthétique chinois ineffable). Pour louer une œuvre chinoise : 这首诗很有意境 (ce poème a beaucoup d\'意境) = compliment maximal.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '人格 (réngé) = PERSONNALITÉ AU SENS PSYCHO-JURIDIQUE (la personne en tant que sujet moral). 人格尊严 (dignité de la personne), 人格分裂 (dédoublement de personnalité). Plus formel/scientifique. 品格 (pǐngé) = CARACTÈRE MORAL (qualités vertueuses). 品格高尚 (caractère noble), 培养品格 (former le caractère). Connote la VERTU. 性格 (xìnggé) = TEMPÉRAMENT, traits psychologiques (introverti, extraverti, calme). 性格内向 (tempérament introverti). Plus quotidien. Hierarchy : 性格 (tempérament psycho) < 人格 (personnalité juridique/morale) < 品格 (caractère vertueux). Erreur classique : 性格高尚 ✗ → 品格高尚 ✓ (le tempérament est neutre, la VERTU est noble).',
    bodyEn:
...
export const c21NuancesM7LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '智 (zhì) = SAGESSE PRATIQUE (savoir agir avec discernement). 智慧 (sagesse), 智者 (le sage). L\'une des 五常 confucéennes. Connote l\'INTELLIGENCE appliquée. 知 (zhī) = CONNAÎTRE / SAVOIR (acquérir par l\'apprentissage). 知识 (savoir), 知道 (savoir). Plus large, plus passif. 识 (shí) = RECONNAÎTRE / IDENTIFIER (distinguer parmi plusieurs). 认识 (connaître par expérience), 见识 (vue / expérience), 识别 (identifier). Connote la CAPACITÉ DE DISCERNEMENT. Hierarchy : 知 (savoir acquis) < 识 (capacité de discernement) < 智 (sagesse pratique appliquée). Compliment : « 您是有智慧的人 » > « 您知识丰富 » (sage > savant).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '境界 (jìngjiè) = NIVEAU SPIRITUEL/PHILOSOPHIQUE atteint (état de l\'être). 王国维 (Wang Guowei) a posé les « 三种境界 » de la création : (1) 独上高楼，望尽天涯路 ; (2) 衣带渐宽终不悔 ; (3) 蓦然回首，那人却在灯火阑珊处. Profondément culturel. 层次 (céngcì) = NIVEAU STRUCTUREL (couches d\'analyse, hiérarchie). 高层次的人 (personne de haut niveau intellectuel/social). Plus structurel. 水平 (shuǐpíng) = NIVEAU MESURABLE (compétence, performance). 学习水平 (niveau scolaire). Plus quantitatif. Hierarchy : 水平 (mesurable concret) < 层次 (structurel intellectuel) < 境界 (spirituel philosophique). Pour louer un sage : « 您的境界让我景仰 » (votre niveau spirituel m\'inspire le respect).',
    bodyEn:
...
export const c21WenyanIntroM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Le 文言文 (chinois classique) n\'est pas une langue MORTE — c\'est le RÉSERVOIR culturel dans lequel tout chinois moderne soutenu puise. Quand un éditorialiste écrit 不容置疑 (« hors de doute »), 不可逾越 (« infranchissable »), c\'est du 文言 condensé. Quand un homme politique cite 子曰 X (« Confucius dit X »), c\'est du 文言 brut. Sans bases en 文言, tu PLAFONNES à un C1.5 — tu ne décodes pas 30% des éditoriaux soutenus. Avec ces bases, tu débloques : éditoriaux, philosophie, poésie, romans classiques, calligraphie. ROI immense pour quelques dizaines d\'heures d\'étude. Approche : pas la grammaire formelle, mais 50 phrases-clés à mémoriser + reconnaître les particules.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'En chinois MODERNE, on a des bi-syllabes : 朋友 (péngyou, ami), 学习 (xuéxí, étudier), 国家 (guójiā, pays). En 文言, chaque caractère est UN MOT INDÉPENDANT : 朋 = ami, 友 = compagnon, 学 = étudier, 习 = pratiquer répétitivement, 国 = État, 家 = famille/clan. Donc un texte 文言 a 2x moins de caractères pour la même densité d\'information. Exemple : 学而时习之 (5 char) = « étudier (学) et (而) en temps voulu (时) pratiquer (习) cela (之) », équivalent moderne en ~15 syllabes. Conséquence pratique : LIS LENTEMENT. Chaque caractère mérite son temps. Les Chinois cultivés mettent 10 minutes pour lire un poème de 28 caractères — et c\'est NORMAL.',
    bodyEn:
...
export const c21WenyanIntroM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Vie 1 : DÉTERMINATIF (= 的 moderne). 孔子之书 = les livres DE Confucius. 国家之大 = grandeur DU pays. C\'est l\'usage le plus FRÉQUENT — apparait dans 60% des occurrences. Vie 2 : PRONOM OBJET (3e personne, lui/elle/cela). 爱之 = aimer [lui/elle/cela]. 学而时习之 = étudier et pratiquer CELA en temps voulu. Vie 3 : VERBE « aller à » (rare mais à connaître). 之于 X = se rendre à X. 子之武城 = le Maître se rendit à Wucheng. Test contextuel : si après 之 il y a un nom → vie 1 (de). Si après 之 il y a une fin de phrase → vie 2 (cela). Si après 之 il y a un lieu → vie 3 (aller).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '者 (zhě) transforme un VERBE ou un ADJECTIF en NOM. 善 (bon) + 者 = 善者 (celui qui est bon, le bien). 学 (étudier) + 者 = 学者 (celui qui étudie, le lettré). 古之学者 = les lettrés d\'autrefois. 仁者爱人 = celui qui est bienveillant aime les autres. Vivant en chinois moderne : 学者 (érudit), 作者 (auteur), 读者 (lecteur), 记者 (journaliste). 所 (suǒ) construit le PASSIF : « ce qui est X » ou « la chose X-ée ». 所爱 = ce qui est aimé / l\'être aimé. 所闻 = ce qu\'on entend. 所见 = ce qu\'on voit. Combo classique : 所以 (suǒyǐ, vivant en moderne comme « donc ») = à l\'origine en 文言 « ce par quoi », d\'où le sens causal qui en a découlé.',
    bodyEn:
...
export const c21WenyanIntroM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '也 (yě) en 文言 = particule de DÉFINITION ou d\'AFFIRMATION SOLENNELLE en fin de phrase. Souvent : sujet + 也 = « X est… ». Exemple célèbre : 仁者，爱人也 = « être humain bienveillant, c\'est aimer les autres ». 仁，礼之本也 = « la bienveillance, c\'est le fondement des rites ». Sans 也, l\'affirmation ne sonne pas DÉFINITIONNELLE. Sens MODERNE de 也 (= « aussi, également ») est SECONDAIRE et historiquement tardif. 矣 (yǐ) = particule d\'ASPECT ACCOMPLI (= moderne 了) + nuance de jugement. 此之谓大丈夫矣 = « c\'est cela qu\'on appelle un vrai homme ». Souvent en clôture d\'un discours : « voilà, c\'est dit, c\'est jugé, c\'est fini ». Aspect accompli + définitif.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '乎 (hū) = particule INTERROGATIVE en fin de phrase (= moderne 吗 ou 呢). Exemple emblématique : 学而时习之，不亦说乎 ? = « Apprendre et pratiquer en temps voulu, n\'est-ce pas une joie ? ». 不亦 X 乎 = « n\'est-ce pas X ? » est UNE structure rhétorique CLÉ pour poser une question dont la réponse positive est évidente — outil de persuasion lettré. 哉 (zāi) = particule EXCLAMATIVE admirative en fin de phrase. 善哉 ! = « comme c\'est bien ! ». 大哉 ! = « comme c\'est grand ! ». Réservé aux MOMENTS de grande émotion intellectuelle. Très théâtral. Reconnaître 哉 dans un texte = comprendre que l\'auteur s\'enthousiasme. Sans 哉, la phrase resterait factuelle.',
    bodyEn:
...
export const c21WenyanIntroM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '子曰：「学而时习之，不亦说乎? 有朋自远方来，不亦乐乎? 人不知而不愠，不亦君子乎?」 Décortiquons : 子 (le Maître = Confucius) 曰 (dit) — formule rituelle de citation. 学 (étudier) 而 (et) 时 (en temps voulu) 习 (pratiquer) 之 (cela), 不亦 (n\'est-ce pas) 说 (= 悦 joie) 乎 (?) — apprendre + revoir = joie. 有 (avoir) 朋 (ami) 自 (depuis) 远方 (lointaine région) 来 (venir), 不亦乐乎 = un ami vient de loin, n\'est-ce pas un bonheur. 人 (les hommes) 不知 (ne pas connaître/reconnaître) 而 (mais) 不愠 (ne pas être affecté), 不亦君子乎 = ne pas être reconnu sans s\'en émouvoir, n\'est-ce pas le propre du noble. CHAQUE écolier chinois la sait. Si tu la cites, tu signales TON niveau cultivé.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '(1) 学而不思则罔，思而不学则殆 = « étudier sans réfléchir mène à la confusion, réfléchir sans étudier est dangereux ». À utiliser en débat sur l\'éducation. (2) 三人行，必有我师焉 = « parmi 3 personnes qui marchent ensemble, il y a forcément un maître pour moi » — humilité. À utiliser pour louer un junior. (3) 己所不欲，勿施于人 = « ne fais pas à autrui ce que tu ne voudrais pas qu\'on te fasse » — règle d\'or version Confucius. (4) 知之为知之，不知为不知，是知也 = « savoir ce qu\'on sait et savoir ce qu\'on ignore, c\'est cela savoir » — humilité épistémique. (5) 君子和而不同，小人同而不和 = « le noble s\'accorde sans uniformité, l\'homme commun s\'uniformise sans s\'accorder » — éthique du dialogue. Ces 5 citations couvrent 80% des références classiques en discussion contemporaine.',
    bodyEn:
...
export const c21PhiloClassiqueM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '孔子 (Kong Zi, -551 → -479) naît dans le royaume de Lu (actuel Shandong). Orphelin de père tôt, élevé pauvre par sa mère. Devient fonctionnaire mineur, puis enseigne. Accepte des élèves indépendamment de leur origine sociale (révolutionnaire à l\'époque) — d\'où sa qualification de « 1er enseignant universel » de l\'histoire chinoise. Voyage 13 ans à travers les royaumes pour proposer ses idées politiques aux souverains — TOUS les rejettent. Rentre chez lui, enseigne jusqu\'à sa mort. Il meurt en pensant avoir échoué. 200 ans après, sa pensée devient pilier d\'État sous la dynastie Han. Aujourd\'hui : sa tombe à Qufu (Shandong) est un site UNESCO, le 孔府 (palais Kong) où ses descendants ont vécu pendant 2000 ans est encore visitable.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '五常 (5 vertus constantes) : 仁 (humanité bienveillante — concept central), 义 (justice/devoir moral), 礼 (rites/bienséance sociale), 智 (sagesse pratique), 信 (fidélité à la parole). Ces 5 sont à mémoriser comme une CHAÎNE — chaque vertu en alimente une autre. 五伦 (5 relations sociales fondamentales) : 君臣 (souverain-sujet), 父子 (père-fils, devenu modèle de la 孝 piété filiale), 夫妇 (mari-femme), 兄弟 (frères, modèle de l\'amitié), 朋友 (amis). Chaque relation a des DEVOIRS RÉCIPROQUES. La 孝 (xiào, piété filiale) reste dans la Chine moderne : prendre soin des parents âgés est un DEVOIR LÉGAL en Chine (loi 2013 obligeant à visiter ses parents âgés régulièrement). Confucius reste opérationnel.',
    bodyEn:
...
export const c21PhiloClassiqueM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '《道德经》(Dào Dé Jīng) attribué à 老子 (Lao Zi, VIe siècle av. JC) — figure semi-légendaire, archiviste de Zhou. Le texte ouvre par : 道可道，非常道。名可名，非常名 = « la Voie qu\'on peut dire/définir n\'est pas la Voie éternelle. Le nom qu\'on peut nommer n\'est pas le nom éternel ». Premier paradoxe : DIRE LE TAO le diminue. Le tao est INDICIBLE, ce que les mots peuvent atteindre n\'est qu\'une approximation. Cette ouverture est l\'une des phrases les plus citées de toute la littérature chinoise. Pour la mémoriser : 道可道 (3 fois 道, le 1er = nom, le 2e = verbe « dire ») 非常道 (n\'est pas le tao éternel). Très joli rythme. Si tu cites cette phrase à un Chinois cultivé, il/elle comprendra ton niveau immédiatement.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '庄子 (Zhuang Zi, ~369-286 av. JC) développe le taoïsme par PARABOLES poétiques (vs Lao Zi en aphorismes). La plus célèbre : 庄周梦蝶 (Zhuāng Zhōu mèng dié, « Zhuang Zhou rêve [qu\'il est] un papillon »). « Un jour, Zhuang Zhou rêva qu\'il était un papillon, voletant librement. Il ignorait être Zhuang Zhou. Soudain il s\'éveilla, et était de nouveau Zhuang Zhou. Mais il ne savait plus : Zhuang Zhou avait-il rêvé d\'être papillon, ou un papillon rêvait-il maintenant d\'être Zhuang Zhou ? ». Question : qu\'est-ce qui distingue le rêve de la veille, l\'humain de la nature, le sujet de l\'objet ? Le 物化 (wùhuà, transformation des choses) abolit les frontières. Cette parabole inspire écrivains (Borges en « Les ruines circulaires »), films, et reste une des phrases les plus connues en Chine.',
    bodyEn:
...
export const c21PhiloClassiqueM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '法家 (l\'École des légistes) repose sur UN postulat : l\'homme est NATURELLEMENT MAUVAIS, intéressé, calculateur. Donc gouverner par la VERTU (option confucéenne) est utopique. Il faut LA LOI 法 (fǎ), claire et appliquée à TOUS sans exception, soutenue par la RÉCOMPENSE et la PUNITION. Théoriciens : 商鞅 (Shang Yang, IVe s. av. JC) appliqua le légisme au royaume de Qin, qui devint surpuissant et unifia la Chine en -221. 韩非 (Han Fei, IIIe s. av. JC) synthétisa la doctrine dans 《韩非子》. Triade légiste : 法 (la loi), 术 (les techniques de pouvoir/contrôle bureaucratique), 势 (la position de pouvoir, l\'autorité du trône). Pour Han Fei, un souverain doit MANIPULER les 3 leviers en parallèle. Modernité : la gouvernance chinoise reste largement légiste sous une façade confucéenne.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '儒表法里 (rú biǎo fǎ lǐ, « confucéen en façade, légiste à l\'intérieur ») = formule INVENTÉE PAR LES HISTORIENS pour caractériser la gouvernance chinoise depuis 2000 ans. Les empereurs Han réhabilitent Confucius officiellement (l\'État se présente comme bienveillant), mais en pratique appliquent les méthodes légistes (lois strictes, bureaucratie centralisée, contrôle, punitions). Cette dualité explique pourquoi des observateurs occidentaux croient parfois la Chine « confucéenne et harmonieuse » alors que les leviers de pouvoir restent légistes. Modernité : la Chine de Xi Jinping s\'inscrit dans cette tradition — discours moral confucéen (中国梦, 共同富裕) + appareil de contrôle légiste (Big Data, score social, fermeté juridique). Maîtriser 儒表法里 = clé de compréhension géopolitique.',
    bodyEn:
...
export const c21PhiloClassiqueM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      'Le 佛教 (bouddhisme) entre en Chine au Ier siècle de notre ère via la Route de la Soie (caravanes indo-chinoises). Premier temple : 白马寺 (Baima Si, Temple du Cheval Blanc) à Luoyang, fondé en 68 sous l\'empereur Ming des Han. Sous les Tang (618-907), explosion : traduction massive des sutras, création du 禅宗 (Chan, école méditative qui donnera le Zen au Japon), construction de monastères majeurs (莫高窟 Mogao, 龙门 Longmen). Sinisation : le bouddhisme indien, abstrait, fusionne avec le 道 (Tao) chinois pour devenir plus PRATIQUE et IMAGÉ. Le 观音 (Guanyin, bodhisattva de la compassion) se féminise en Chine (alors qu\'Avalokiteśvara est masculin en Inde). Aujourd\'hui : ~250M de bouddhistes en Chine — plus grande population bouddhiste au monde.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '禅 (chán) du sanskrit dhyāna (« méditation »), via le 禅宗 (école Chan) qui devient le 禅 japonais (Zen) après son passage par la Corée. Originalité du Chan : refus des SUTRAS lourds, focus sur l\'ÉVEIL DIRECT par méditation 坐禅 (zuò chán, « assis à méditer », jap. zazen) et 公案 (gōng\'àn, koan, énigmes paradoxales). Maître Bodhidharma 达摩 aurait médité 9 ans face à un mur à Shaolin — modèle de la dévotion. Phrase Chan célèbre : 不立文字，直指人心 = « ne s\'appuyer sur aucun mot, viser directement le cœur de l\'homme ». L\'éveil est INSTANTANÉ et HORS du langage. Aujourd\'hui : pratique du 禅 reprend en Chine urbaine (retraites, applications de méditation), souvent sous forme laïque proche du mindfulness occidental.',
    bodyEn:
...
export const c21PoetryM1LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '绝句 (juéjù, « quatrain coupé ») = 4 vers, chacun de 5 caractères (五绝 wǔjué) ou 7 caractères (七绝 qījué). Forme la plus courte et la plus populaire de la poésie classique. Contraintes : (1) RIME entre vers 2 et 4 (parfois aussi vers 1), (2) ALTERNANCE de tons plats (平 píng, ton 1 ou 2 en mandarin moderne) et obliques (仄 zè, tons 3 et 4), (3) PARALLÉLISME possible entre vers (ex : « ciel haut » ↔ « eau profonde »). Exemple emblématique : 《静夜思》de Li Bai (5 char × 4 vers = 20 caractères seulement). Le 绝句 condense en 20-28 caractères ce qu\'un poème français mettrait 4 strophes à exprimer. Économie radicale = leçon de style.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '律诗 (lǜshī, « poème régulé ») = 8 vers, en 五律 ou 七律. Beaucoup plus contraignant que le 绝句. Règles : (1) RIME aux vers 2, 4, 6, 8, (2) ALTERNANCE STRICTE de tons selon un schéma codifié, (3) ANTITHÈSE OBLIGATOIRE entre les vers 3-4 (paire centrale 1) et 5-6 (paire centrale 2). L\'antithèse impose des correspondances syntaxiques + sémantiques entre les vers : nom ↔ nom, verbe ↔ verbe, adjectif ↔ adjectif, et catégories sémantiques cohérentes (couleur ↔ couleur, paysage ↔ paysage). Forme préférée de Du Fu (杜甫), surnommé « 诗圣 » (Sage de la poésie). Le 律诗 = sommet de la poésie chinoise classique en termes d\'EXIGENCE technique. Forme TRÈS difficile à composer ; encore plus à traduire.',
    bodyEn:
...
export const c21PoetryM2LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '李白 (Li Bai, 701-762) né dans le Sichuan ou en Asie centrale (origine débattue). Talent précoce : poèmes recommandés à l\'empereur Tang Xuanzong, qui l\'invite à la cour. Mais Li Bai préfère le vin et la liberté : se fâche avec les ministres, est éloigné. Vie de voyageur. Mort tragique selon la légende : se serait noyé en essayant d\'embrasser le reflet de la lune dans un fleuve, ivre. Style : LIBRE, IMAGÉ, COSMIQUE. Thèmes obsessionnels : la lune 月, le vin 酒, la nature majestueuse, le voyage, la nostalgie 思乡. Surnommé 诗仙 (« Immortel de la poésie ») par opposition à Du Fu, le « Sage ». Œuvres : ~1000 poèmes conservés. Le quatrain le plus célèbre : 《静夜思》(20 caractères seulement, étudié dans la prochaine leçon).',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '《静夜思》(Jìngyè sī, « Pensée d\'une nuit paisible ») de Li Bai. 20 caractères : 床前明月光，疑是地上霜。举头望明月，低头思故乡。 Décortiquons : 床前 (devant le lit) 明月光 (la clarté de la lune brillante), 疑 (je doute) 是 (que ce soit) 地上霜 (givre sur le sol). 举头 (je lève la tête) 望 (et regarde) 明月 (la lune brillante), 低头 (je baisse la tête) 思 (et pense à) 故乡 (mon pays natal). Mécanisme poétique : la confusion lune/givre crée le frisson, le mouvement haut/bas crée le balancement émotionnel, la lune devient le PONT entre l\'exilé et la maison. CHAQUE Chinois (école primaire) connaît ce poème PAR CŒUR. Si tu peux le réciter, tu peux nouer une discussion poétique avec n\'importe quel Chinois.',
    bodyEn:
...
export const c21PoetryM3LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '杜甫 (Du Fu, 712-770) né à Henan. Ami et contemporain de Li Bai (ils se rencontrent en 744), mais vie radicalement différente : fonctionnaire malheureux, témoin de la révolte d\'An Lushan (755-763) qui ravage l\'empire Tang. Sa poésie devient le MIROIR DE LA SOUFFRANCE collective : guerre, exil, faim, famille séparée, désastres naturels. Surnommé 诗圣 (« Sage de la poésie ») et 诗史 (« Histoire en poèmes ») car ses œuvres documentent l\'époque. Style : RIGOUREUX (maître du 律诗), GRAVE, MORAL. Œuvres marquantes : 《春望》(le printemps regardé pendant la guerre), 《茅屋为秋风所破歌》(sa hutte de chaume détruite par le vent d\'automne — il pense aux pauvres avant à lui-même). Mort en 770, malade, sur un bateau. Aujourd\'hui : la maison de Du Fu à Chengdu (杜甫草堂) est un musée majeur.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      'Li Bai et Du Fu sont l\'OPPOSITION fondamentale de la poésie chinoise. Li Bai = JOIE, IVRESSE, COSMOS, LIBERTÉ INDIVIDUELLE. Du Fu = SOUFFRANCE, RIGUEUR, MORALE, ENGAGEMENT COLLECTIF. Surnommés 诗仙 (Immortel) vs 诗圣 (Sage). Cette opposition est l\'équivalent chinois de Dionysos vs Apollon, de Rimbaud vs Hugo, de l\'individuel vs le collectif, du romantisme vs le classicisme. Poser la question à un Chinois cultivé : « 您更喜欢李白还是杜甫 ? » (vous préférez Li Bai ou Du Fu ?) ouvre une discussion révélatrice. Beaucoup avouent : « jeune, j\'aimais Li Bai ; en vieillissant, je préfère Du Fu ». L\'évolution Li Bai → Du Fu suit la maturité psychologique. Question MAGIQUE pour démarrer un débat littéraire profond.',
    bodyEn:
...
export const c21PoetryM4LearnSections: LessonV2LearnSection[] = [
  {
    ...
    body:
      '李清照 (Li Qingzhao, 1084-1155) née sous les Song du Nord dans une famille lettrée : père haut fonctionnaire, mère cultivée. Mariée à 18 ans à 赵明诚 (Zhao Mingcheng), érudit collectionneur d\'antiques. Couple intellectuel HARMONIEUX qui collabore sur 《金石录》(catalogue d\'inscriptions). Poésie de 1re moitié de vie : JOIE conjugale, vie raffinée. CATASTROPHE en 1127 : invasion Jürchen, exil au sud, perte de leurs collections, mort de son mari en 1129. Poésie de 2e moitié : DEUIL et SOLITUDE. Spécialiste du 词 (poésie chantée Song). Œuvre la plus citée : 《声声慢》qui s\'ouvre par 7 redoublements consécutifs : 寻寻觅觅，冷冷清清，凄凄惨惨戚戚 — climat de désolation incomparable. Surnommée 千古第一才女 (« 1re femme de génie à travers les siècles »). Prouve que la littérature classique chinoise a fait place à des voix féminines d\'exception.',
    bodyEn:
  ...
  },
  {
    ...
    body:
      '《声声慢》(Shēng shēng màn, « Lentement, son après son ») s\'ouvre par 14 caractères en 7 paires de redoublements : 寻寻 (xún xún, chercher chercher) 觅觅 (mì mì, chercher chercher) 冷冷 (lěng lěng, froid froid) 清清 (qīng qīng, désolé désolé) 凄凄 (qī qī, mélancolique mélancolique) 惨惨 (cǎn cǎn, désespéré désespéré) 戚戚 (qī qī, navrant navrant). Aucune autre ouverture en littérature mondiale n\'utilise 7 redoublements consécutifs. L\'effet : un climat physiquement RESSENTI de DÉSOLATION. La traduction française la plus connue rend : « Je cherche, je cherche, froid désolé, triste triste navrant ». Ce poème est étudié dans TOUS les manuels chinois et reste l\'un des sommets absolus du 词 Song. Le mémoriser est un défi à la portée d\'un C2.1 motivé.',
    bodyEn:
